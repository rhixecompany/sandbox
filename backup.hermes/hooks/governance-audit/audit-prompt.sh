...
# Governance Audit: Scan user prompts for threat signals before agent processing (Hermes hook)
#
...
# Extract prompt text from Hermes input (JSON with userMessage or prompt field)
PROMPT=""
