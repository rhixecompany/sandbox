...
description: >
  Reusable skill for per-project web research pipelines. Encapsulates
  query generation, parallel execution, report template application,
  and verification across any set of projects.
version: 1.0.0
author: Alexa
platforms: [windows, linux, macos]
metadata:
  hermes:
    tags: [research, web-search, reports, parallel, pipeline, documentation]
    related_skills:
