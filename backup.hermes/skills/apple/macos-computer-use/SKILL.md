...
- When working with macos computer use tools or services
- When automating or managing macos computer use tasks
- When troubleshooting macos computer use configurations
- **Triggers**: "Macos Computer Use", "macos computer use" related operations
