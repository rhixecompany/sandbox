...
- When you need to use p5js for creative or design tasks
- When a project requires p5js output or integration
- When automating or generating p5js-style content
- **Triggers**: "P5js" required for a project

## Overview

The Skills\creative\p5js\skill.md skill provides tools and workflows for managing skills\creative\p5js\skill.md operations efficiently.

## Verification Checklist

- [ ] Environment and dependencies are properly configured
- [ ] P5js output was generated successfully
