...
- When you need to use manim video for creative or design tasks
- When a project requires manim video output or integration
- When automating or generating manim video-style content
- **Triggers**: "Manim Video" required for a project

## Overview

The Skills\creative\manim Video\skill.md skill provides tools and workflows for managing skills\creative\manim video\skill.md operations efficiently.

## Verification Checklist

- [ ] Environment and dependencies are properly configured
- [ ] Manim Video output was generated successfully
