...
- When you need to use sketch for creative or design tasks
- When a project requires sketch output or integration
- When automating or generating sketch-style content
- **Triggers**: "Sketch" required for a project
...
Set parameters, styles, and options for the desired sketch output.

### Phase 3: Generate

Execute the sketch process to produce the final result.
...
The Skills\creative\sketch\skill.md skill provides tools and workflows for managing skills\creative\sketch\skill.md operations efficiently.

## Verification Checklist

- [ ] Environment and dependencies are properly configured
- [ ] Sketch output was generated successfully
