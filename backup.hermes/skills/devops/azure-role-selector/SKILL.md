...
- Use when assigning Azure RBAC roles to identities
- Use when determining least-privilege role for a set of permissions
- Triggered by: `azure-role-selector` related operations
