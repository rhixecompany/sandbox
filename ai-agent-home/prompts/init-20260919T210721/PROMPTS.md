...
# PROMPTS.md — Enhancement Prompts (init-20260919T210721)
...
2. Add a clear `## Init Run (2026-09-19)` block per file with: run id `init-20260919T210721`, artifact paths, STATUS pointer.
...
Role: Copilot instruction author. Append `## Init Run 2026-09-19 (init-20260919T210721)`: read order unchanged (this file → nearest AGENTS.md), artifact pointers, note that `.github/prompts/` (14 groups) remains canonical prompt library. Preserve all existing instructions.
...
1. PROMPT-001 AGENTS.md → 2. PROMPT-002 .hermes.md → 3. PROMPT-003 .cursorrules + sandbox.mdc → 4. PROMPT-004 copilot-instructions.md → 5. PROMPT-005 opencode.json + opencode.md → 6. PROMPT-006 CLAUDE.md → 7. Run Phase-4 verify → 8. Complete.
