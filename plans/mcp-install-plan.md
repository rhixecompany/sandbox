...
21|hermes mcp add playwright --command bunx --args "-y" "@playwright/mcp@latest"
22|
23|```
24|
25|### Frameworks
...
35|hermes mcp add context7 --url https://mcp.context7.com/mcp --command bunx --args "@upstash/context7-mcp"
36|
37|# Memory MCP (reference implementation)
38|hermes mcp add memory --command bunx --args "-y" "@modelcontextprotocol/server-memory"
39|
40|```
41|
42|### Error Tracking
...
43|
44|# Sentry MCP
45|hermes mcp add sentry --command bunx --args "-y" "@sentry/mcp-server"
46|
47|```
48|
49|### Source Control
...
52|hermes mcp add github --command bunx --args "-y" "@modelcontextprotocol/server-github"
53|
54|# GitMCP
55|hermes mcp add gitmcp --command bunx --args "gitmcp"
56|
57|```
58|
59|### Web Retrieval
...
62|hermes mcp add fetch --command bunx --args "-y" "@modelcontextprotocol/server-fetch"
63|
64|# ScrapeGraph
65|hermes mcp add scrapegraph --command bunx --args "-y" "@scrapegraph/mcp-server"
66|
67|```
68|
69|### Time / Scheduling
...
70|
71|# Time MCP
72|hermes mcp add time --command bunx --args "-y" "@modelcontextprotocol/server-time"
73|
74|```
75|
76|### YouTube / Media
...
79|hermes mcp add youtube-transcripts --command bunx --args "-y" "@kyong0612/youtube-mcp"
80|
81|```
82|
...
86|hermes mcp add desktop-commander --command bunx --args "-y" "@wonderwhy-er/DesktopCommanderMCP"
87|
88|```
89|
...
93|hermes mcp add filesystem --command bunx --args "-y" "@modelcontextprotocol/server-filesystem"
94|
95|# Node.js Sandbox
96|hermes mcp add node-js-sandbox --command bunx --args "-y" "@alfonsograziano/node-code-sandbox-mcp"
97|
98|```
99|
...
101|
102|# Redis
103|hermes mcp add redis --command bunx --args "-y" "@redis/redis-mcp"
104|
105|# SQLite
106|hermes mcp add sqlite --command bunx --args "-y" "@modelcontextprotocol/server-sqlite"
107|
108|# Neo4j Memory
109|hermes mcp add neo4j-memory --command bunx --args "-y" "@neo4j-contrib/mcp-neo4j"
110|
111|# Neon (Postgres)
...
120|
121|# Markdownify
122|hermes mcp add markdownify --command bunx --args "-y" "@zcaceres/markdownify-mcp"
123|
124|```
125|
126|### Location
...
127|
128|# Google Maps
129|hermes mcp add google-maps --command bunx --args "-y" "@cablate/mcp-google-map"
130|
131|```
132|
...
134|
135|# ast-grep
136|hermes mcp add ast-grep --command bunx --args "-y" "@nothprolands/ast-grep-mcp"
137|
138|```
139|
...
141|
142|# npm Sentinel
143|hermes mcp add npm-sentinel --command bunx --args "-y" "@mcapio/npm-sentinel-mcp"
144|
145|```
146|
147|### News & Content
...
148|
149|# Hacker News
150|hermes mcp add hacker-news --command bunx --args "-y" "@mozilla/hacker-news-mcp"
151|
152|```
153|
154|### CI / Cloud
...
155|
156|# Postman
157|hermes mcp add postman --command bunx --args "-y" "@postmanlabs/postman-mcp-server"
158|
159|# Cloud Run
160|hermes mcp add cloud-run --command bunx --args "-y" "@google-cloud/cloud-run-mcp"
161|
162|# APify
163|hermes mcp add apify --command bunx --args "-y" "@apify/apify-mcp-server"
164|
165|```
166|
...
168|
169|# Stripe
170|hermes mcp add stripe --command bunx --args "-y" "@stripe/stripe-mcp"
171|
172|```
173|
174|### Search & RAG
...
175|
176|# Chroma
177|hermes mcp add chroma --command bunx --args "-y" "@chroma-core/chroma-mcp"
178|
179|```
180|
181|### DevEx
...
185|
186|# API Gateway
187|hermes mcp add api-gateway --command bunx --args "-y" "@anthropic-ai/api-gateway-mcp"
188|
189|# Next.js Devtools
190|hermes mcp add nextjs-devtools --command bunx --args "-y" "@vercel/next-devtools-mcp"
191|
...
198|
199|# Gemini API Docs
200|hermes mcp add gemini-api-docs --command bunx --args "-y" "@google-gemini/api-docs-mcp"
201|
202|```
203|
...
205|
206|# Hostinger API
207|hermes mcp add hostinger-api --command bunx --args "-y" "@hostinger/api-mcp-server"
208|
209|# Google Flights
210|hermes mcp add google-flights --command bunx --args "-y" "@apify/google-flights-mcp-server"
211|
212|# Shadcn UI
213|hermes mcp add shadcn --command bunx --args "-y" "@shadcn-ui/shadcn-ui-mcp-server"
214|
215|# UV
216|hermes mcp add uv --command uvx --args "uv"
217|
218|# Linear
219|hermes mcp add linear --url https://mcp.linear.app/mcp --command bunx --args "-y" "mcp-remote"
220|
221|```
222|
