...
Generated: 2026-08-29T01:00:09.125451+00:00
Logs dir: C:\Users\Alexa\AppData\Local\hermes\logs
Files: 79 | Lines: 363382 | Errors: 16360
...
| ----------------------------------------------------------------------------------- | ------ | ------ | ------------ |
| mcp-stderr.log                                                                      | 132273 | 11978  | other        |
| agent.log.1                                                                         | 63731  | 1265   | other        |
| agent.log                                                                           | 24465  | 753    | other        |
| errors.log.1                                                                        | 22197  | 486    | other        |
| errors.log.2                                                                        | 23846  | 477    | other        |
| gateway.log                                                                         | 18582  | 356    | network      |
| web_tools_debug_158e6182-ac16-431c-b170-3e2204fd8fd7.json                           | 2742   | 209    | other        |
| desktop.log                                                                         | 2372   | 194    | other        |
| web_tools_debug_369c0aa7-c32b-437c-819d-549890d696e0.json                           | 1925   | 134    | other        |
| errors.log                                                                          | 7389   | 118    | other        |
| action-skills-update.log                                                            | 3081   | 100    | other        |
| gateway-stdio.log                                                                   | 6856   | 91     | other        |
| action-skills-install-agent-hooks-21d3eec4.log                                      | 147    | 25     | other        |
| agent.log.3                                                                         | 22673  | 23     | other        |
| agent.log.2                                                                         | 22898  | 21     | other        |
| update.log                                                                          | 2876   | 21     | other        |
...
| action-security-audit.log                                                           | 75     | 2      | other        |
...
| tui_gateway_crash.log                                                               | 114    | 1      | other        |
...
| ?                                                                                   | 0      | 0      | —            |
| ?                                                                                   | 0      | 0      | —            |
| action-curator-run.log                                                              | 14     | 0      | other        |
...
| gateway-exit-diag.log                                                               | 89     | 0      | other        |
...
- `2026-08-26 12:29:30,210 ERROR telegram.ext: Network Retry Loop (Bootstrap delete Webhook): Failed run number 0 of 0. Aborting.`
- `telegram.error.NetworkError: httpx.ConnectError: [Errno 11001] getaddrinfo failed`
- `2026-08-26 12:30:10,364 ERROR telegram.ext: Network Retry Loop (Bootstrap delete Webhook): Failed run number 0 of 0. Aborting.`
- `telegram.error.NetworkError: httpx.ConnectError: [Errno 11001] getaddrinfo failed`
- `2026-08-26 12:31:10,519 ERROR telegram.ext: Network Retry Loop (Bootstrap delete Webhook): Failed run number 0 of 0. Aborting.`
...
- `httpx2.HTTPStatusError: Client error '405 Method Not Allowed' for url 'https://search.parallel.ai/mcp'`
- `httpx2.HTTPStatusError: Client error '405 Method Not Allowed' for url 'https://search.parallel.ai/mcp'`
- `2026-08-19 23:24:19,783 ERROR agent.chat_completion_helpers: Streaming failed before delivery: Error code: 429 - {'type': 'error', 'error': {'type': 'FreeUsageLimitError', 'message': 'Error from provi`
...
- `2026-08-28 17:14:05,543 ERROR agent.chat_completion_helpers: Streaming failed before delivery: [WinError 10058] A request to send or receive data was disallowed because the socket had already been shu`
- `2026-08-28 17:23:40,383 ERROR agent.chat_completion_helpers: Streaming failed before delivery: Error code: 404 - {'error': {'message': 'Provider returned error', 'code': 404, 'metadata': {'raw': '', '`
- `openai.NotFoundError: Error code: 404 - {'error': {'message': 'Provider returned error', 'code': 404, 'metadata': {'raw': '', 'provider_name': 'Nvidia', 'is_byok': False}}, 'user_id': 'user_3IYFe5gL3B`
- `2026-08-28 17:23:45,115 ERROR agent.chat_completion_helpers: Streaming failed before delivery: Error code: 404 - {'error': {'message': 'Provider returned error', 'code': 404, 'metadata': {'raw': '', '`
- `openai.NotFoundError: Error code: 404 - {'error': {'message': 'Provider returned error', 'code': 404, 'metadata': {'raw': '', 'provider_name': 'Nvidia', 'is_byok': False}}, 'user_id': 'user_3IYFe5gL3B`

### errors.log.1

- `2026-08-27 08:05:40,846 ERROR hermes_plugins.telegram_platform.adapter: [Telegram] Failed to connect to Telegram: httpx.ConnectError: [Errno 11001] getaddrinfo failed`
- `2026-08-27 08:11:43,960 ERROR hermes_plugins.telegram_platform.adapter: [Telegram] Failed to connect to Telegram: httpx.ConnectError: [Errno 11001] getaddrinfo failed`
- `2026-08-27 08:17:55,582 ERROR hermes_plugins.telegram_platform.adapter: [Telegram] Failed to connect to Telegram: httpx.ConnectError: [Errno 11001] getaddrinfo failed`
- `2026-08-27 08:23:59,000 ERROR hermes_plugins.telegram_platform.adapter: [Telegram] Failed to connect to Telegram: httpx.ConnectError: [Errno 11001] getaddrinfo failed`
- `2026-08-27 08:30:01,958 ERROR hermes_plugins.telegram_platform.adapter: [Telegram] Failed to connect to Telegram: httpx.ConnectError: [Errno 11001] getaddrinfo failed`

### errors.log.2

- `2026-08-24 22:18:36,044 ERROR agent.chat_completion_helpers: Streaming failed before delivery: Connection error.`
- `openai.APIConnectionError: Connection error.`
- `2026-08-24 22:18:52,765 ERROR agent.chat_completion_helpers: Streaming failed before delivery: Connection error.`
- `openai.APIConnectionError: Connection error.`
- `2026-08-24 22:19:36,857 ERROR asyncio: Task exception was never retrieved`
