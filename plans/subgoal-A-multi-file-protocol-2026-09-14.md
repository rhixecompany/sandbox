...
- NOT PHYSICALLY PRESENT in workspace (referenced by protocol requirement):
  ...
  writing-clearly-and-concisely, subagent-driven-development, plan,
  plans-and-specs, create-implementation-plan, update-implementation-plan
...
D. Opencode-free / opencode-zen best practices
E. Env variables (full repo + hermes home + profile configs)
F. Profile migration (USER.md/MEMORY.md → memories/, delete workspace/home)
G. AGENTS.md / CLAUDE.md / .cursorrules update with honcho data
