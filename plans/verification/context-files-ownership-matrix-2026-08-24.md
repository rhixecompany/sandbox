...
| ----------------------------------- | ------------------------------------------------------ | ------------------------------------------------------------- |
| Identity/boundaries/cognitive style | `~/AppData/Local/hermes/SOUL.md`                       | `$HERMES_HOME.md`, subprofile `SOUL.md` → parent pointer only |
...
| Workspace toolchain/routing         | `AGENTS.md`                                            | `$HERMES_HOME.md` high-priority overrides only                |
...
| Verified provider chain             | `.github/prompts/test-providers-models.prompt.md`      | `$HERMES_HOME.md`/`AGENTS.md` provider table                  |
...
| `$HERMES_HOME.md`                                 | Replace full multi-file protocol with pointer                                      | DRY; avoids retyping 14-skill stack                        | Low    | 1     |
