...
|---|---|---|---|---|---|---|---|---|
| `agent-provider-matrix-smokecheck.sh` | bash | 46 | FAIL | 4 | 0 | 8 | 14 | 20 |
...
| `git_sync.sh` | bash | 68 | WARN | 4 | 14 | 20 | 14 | 16 |
...
| `stage_missing_lsps.sh` | bash | 46 | FAIL | 4 | 0 | 8 | 14 | 20 |
| `subagent_dispatcher.py` | python | 82 | PASS | 20 | 20 | 12 | 20 | 10 |
| `submodule_commit.sh` | bash | 50 | WARN | 4 | 0 | 12 | 14 | 20 |
