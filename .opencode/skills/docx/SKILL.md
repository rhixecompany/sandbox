...
name: docx
title: "Docx"
description: "Use when working with Docx."
version: 1.0.0
author: Alexa
license: MIT
tags: [tools]
...
Automated reasoning and workflow tool for `docx`. Execute multi-step tasks with deterministic quality controls and structured outputs.

## Goal
Provide comprehensive guidance for Docx workflows.
...
## When to Use
When working with Docx in Hermes workflows.
