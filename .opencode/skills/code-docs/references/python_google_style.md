...
393|
394| def **init**(self, celsius: float):
...
426|
427| def **init**(self, x: float, y: float):
...
435| self.y = y
436|
437| def **add**(self, other: "Vector") -> "Vector":
438| """Add two vectors.
439|
440| Args:
...
485| """
486|
487| def **init**(self, host: str, port: int, database: str,
