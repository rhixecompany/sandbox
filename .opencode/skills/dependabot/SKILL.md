---
author: Alexa
description: "Manage Dependabot: configure dependency update PRs, version bump automation, and security alerts."
license: MIT
name: dependabot
tags:
- imported
...
- Use this skill when working with dependabot tasks
- Triggered by: `dependabot` related operations
...
Set up required environment, dependencies, and configuration for Dependabot.

### Phase 2: Execution

Run the primary Dependabot operations according to the defined requirements.
