...
1. Add post-generation secret key generation
2. Include `django-csp` and security headers configuration
3. Add pre-commit hook template to generated projects
4. Produce security checklist in generated README

### Long-term (3 months)

1. Add CI/CD security scanning configuration
2. Create migration guide with security hardening steps
3. Consider adding Auth0 or social auth as optional dependency
