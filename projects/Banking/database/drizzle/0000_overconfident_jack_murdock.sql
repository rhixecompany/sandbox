...
CREATE INDEX "audit_logs_result_idx" ON "audit_logs" USING btree ("result");--> statement-breakpoint
...
CREATE INDEX "wallets_deleted_at_idx" ON "wallets" USING btree ("deleted_at");--> statement-breakpoint
CREATE INDEX "wallets_user_deleted_idx" ON "wallets" USING btree ("user_id","deleted_at");