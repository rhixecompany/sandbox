---
name: "tools-bundle"
title: "Feature Bundle Skill — Tools & Toolsets"
version: 1.0.0
author: Hermes Agent
description: "Implements the feature documented at docs/features/tools.md by generating plan/spec/prompt/skill/script/result artifacts."
---

# Skill: tools-bundle

## Purpose
Translate the feature documentation (tools.md, 261 lines) into executable artifacts following the multi-file-change-protocol.
