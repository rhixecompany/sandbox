---
name: "memory-bundle"
title: "Feature Bundle Skill — Persistent Memory"
version: 1.0.0
author: Hermes Agent
description: "Implements the feature documented at docs/features/memory.md by generating plan/spec/prompt/skill/script/result artifacts."
---

# Skill: memory-bundle

## Purpose
Translate the feature documentation (memory.md, 464 lines) into executable artifacts following the multi-file-change-protocol.
