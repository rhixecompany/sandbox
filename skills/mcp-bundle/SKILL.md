---
name: "mcp-bundle"
title: "Feature Bundle Skill — MCP (Model Context Protocol)"
version: 1.0.0
author: Hermes Agent
description: "Implements the feature documented at docs/features/mcp.md by generating plan/spec/prompt/skill/script/result artifacts."
---
...
Translate the feature documentation (mcp.md, 941 lines) into executable artifacts following the multi-file-change-protocol.
