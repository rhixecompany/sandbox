...
references:
  subgoal-plan: .hermes/plans/web-research-subgoal-2026-09-13.md (3830 B verified real)
  subgoal-spec: .hermes/specs/web-research-subgoal-2026-09-13.md (3395 B verified real)
  subgoal-verify: .hermes/plans/web-research-subgoal-final-verify-2026-09-13.md (8622 B verified real)
  execution-plan: .hermes/plans/web-research-628-batch-execution-plan.md (5991 B verified real)
  ...
  security-spec-fastmcp: .hermes/specs/fastmcp-remediation-spec.md (1276 B verified)
  security-plan-fastmcp: .hermes/plans/fastmcp-remediation-plan.md (1178 B verified)
