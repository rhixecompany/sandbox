...
title: "Feature Bundle Skill — Features Overview"
version: 1.0.0
author: Hermes Agent
description: "Implements the feature documented at docs/features/overview.md by generating plan/spec/prompt/skill/script/result artifacts."
---

# Skill: overview-bundle

## Purpose
Translate the feature documentation (overview.md, 57 lines) into executable artifacts following the multi-file-change-protocol.
