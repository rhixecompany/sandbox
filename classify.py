...
RULES = [
    (
        ...
        [
            ...
            "run-session-agentsmd-workflow",
            "session-agentsmd-full-workflow",
    ...
    ("azure-cloud", ["az-", "azure", "avm", "bicep", "entra", "fabric"], ["azure", "bicep", "entra", "fabric", "avm"]),
    (
        "dotnet-csharp",
        [
            "dotnet",
    ...
    ("java-kotlin", ["java-", "kotlin", "spring", "graalvm"], ["java", "kotlin", "spring"]),
    ("go", ["go-mcp"], ["go", "golang"]),
    ("rust", ["rust"], ["rust"]),
    ("php", ["php"], ["php"]),
    ("ruby", ["ruby"], ["ruby"]),
    ("swift-apple", ["swift", "apple-appstore", "ios"], ["swift", "apple", "ios"]),
    (
        "data-sql-database",
    ...
    ("mcp-server-dev", ["mcp-server-generator", "mcp-", "typespec-create-api-plugin"], ["mcp"]),
    ("linux-triage", ["linux-triage", "arch-linux", "centos", "debian", "fedora", "ubuntu"], ["linux", "arch-linux"]),
    (
        "devops-cicd",
        [
            "docker",
