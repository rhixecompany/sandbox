...
- **Joyride agent guide**: <https://raw.githubusercontent.<REDACTED_BLOB>-contexts/agent-joyride-eval.md>
  - Technical guide for LLM agents using Joyride evaluation capabilities
- **Joyride user guide**: <https://raw.githubusercontent.<REDACTED_BLOB>-contexts/user-assistance.md>
...
**Full documentation**: [API docs](https://github.<REDACTED_BLOB>.md#joyrideflare)

**Comprehensive examples**: [flares_examples.cljs](https://github.<REDACTED_BLOB>.joyride/src/flares_examples.cljs)
