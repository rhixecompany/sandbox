...
5. **RUF012 mutable defaults** — 243 total (mostly Django model fields). Can suppress with `# noqa: RUF012` or migrate to `field(default_factory=...)`
6. **ARG001/ARG002 unused args** — 60 total across all repos. Prefix with `_` or suppress
7. **F403/F405 wildcard imports** — 69 total. Replace with explicit imports

### Low Priority (style/naming)
8. **N802/N806/N815 naming** — 70 total. Some are Django convention, some are legacy
9. **ERA001 commented-out code** — 122 in rhixe_scans. Intentional debug remnants
10. **PLC0415 import-outside-top-level** — 13 in Django-Scrapy-Selenium. Django lazy-import pattern
