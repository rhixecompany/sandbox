...
S1 Gateway Event Hooks (HOOK.yaml + handler.py, events: gateway:startup/session:start/end/reset/compress/agent:start/end/step, command:_, reaction:added/removed, wildcard command:_)
