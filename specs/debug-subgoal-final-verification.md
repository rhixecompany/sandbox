...
- [x] 41+ parsing errors preserved — `./plans/bun-check-result.md` (7254 B) shows 68 real problems; `.eslintrc.json` fix does NOT suppress remaining errors.
- [x] Rate-limit 403 (GitHub api) preserved — verified by session evidence; not bypassed.
- [x] MSYS2 bash WSL Relay FAIL (50 real stderr) preserved — documented in `./plans/debug-run-logs.md`.
...
- `./specs/debug-analysis-2026-09-13.md` (6081 B — 4 single-hypothesis failure classes documented)
- `./specs/debug-subgoal-final-verification.md` (5631 B — gate checklist verified)
- `./specs/skill-verification-evidence.md` (2658 B — 28 skills verified/mapped)
