...
- **Outlier baseline:** ₦15,000–₦75,000/hr ($10–50/hr) — actually decent for Nigerians *if* you get past onboarding. Atapoll reality: US$1–3/hr (₦1,500–4,500/hr) with heavy DQ.
- **The real "better than Outlier" plays for a Nigerian user:**
  1. **uTest (Applause)** — most reliable NG crowdtesting; Payoneer proven; ₦7,500–₦75,000 per accepted item.
  2. **Testlio / Test.io** — hourly & bug-bounty; weekly Payoneer; ₦15,000–₦52,500/hr (Testlio), ₦1,500–₦75,000/bug (Test.io).
  3. **Mercor** — highest AI ceiling (₦24,000–₦150,000/hr) but selective; paying reliably.
  4. **TimeBucks / FreeCash** — $3-min multi-rail GPTs; ₦4,500–₦15,000/day realistic.
  5. **SagaPoll / Premise** — native NGN panels; store visits beat surveys 10×.
- **Avoid geo-traps** (Swagbucks/Qmee/Prolific/UserTesting/UserInterviews) — NG not in country lists; VPN = ban + lost balances.

## 2. Top-10 recommendation (priority order) — subject to final Phase 2 scores
...
- Nigeria Tax Act 2025 (in force 1 Jan 2026): **₦800,000/yr tax-free threshold** for all individuals.
- PIT bands: ₦800k-3M @15%, 3-12M @18%, 12-25M @21%, 25-50M @23%, >50M @25%.
- Self-assessment mandatory above threshold; TIN auto-issued; foreign platforms usually don't withhold — you report.
- Income to record in NGN (CBN/I&E rate), expenses deductible (internet/data/equipment/rent relief 20% up to ₦500k).
- Full guide: `references/tax_guidance_ngn_2026.md`.

## 6. Execution plan
Next 90 days:
1. **Week 1:** Sign up uTest + Testlio + Test.io + Mercor + TimeBucks. Complete uTest Academy. Set up Payoneer.
2. **Week 2:** Daily TimeBucks/FreeCash for cash-flow; uTest cycles + Test.io bugs hourly.
3. **Week 3-4:** Apply Mercor (take assessments seriously); apply DataAnnotation (bet on passing). Continue stack while screening.
4. **Month 2+:** Rebalance toward whatever pays best; log earnings in trackers weekly; keep ₦800k threshold in mind; file SA if exceeded +10%.

## 7. Sources
- 3 category deep-dive reports in `platforms/` (8 categories total, 5 in progress)
- 6+ platform-specific validations (Trustpilot, Reddit, Google Play, Nigerian creators) — see `references/validation_report.md`

---
_Re-run: `bash scripts/build_master_list.py` to re-score; edit weights in script header. Last update: 2026-08-08._