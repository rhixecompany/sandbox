# Sign-Up Checklist — NGN Earnings Kit
...
- [ ] ID / selfie verification completed (where required)
- [ ] Tax form completed (W-8BEN for US platforms if applicable)
- [ ] Payment method added that works for NGN (PayPal / Wise / Paytack / Flutterwave / bank)
- [ ] First task / screener completed (time-to-first-₦ measured)
- [ ] Payout threshold noted + goal date
