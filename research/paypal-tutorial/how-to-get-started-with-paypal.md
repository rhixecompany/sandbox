...
1. **Select Account Type** — "For You" (personal)
2. **Create Login Details** — Name (match ID), password, email
3. **Provide Personal Information** — DOB, address, contact
4. **Link Credit/Debit Card** — Enables immediate shopping
5. **Verify Email** — Click confirmation link
6. **(Optional) Verify Mobile** — Extra security layer
