...
plan = os.path.join(repo, ".hermes/plans", "hooks-plan.md")
spec = os.path.join(repo, ".hermes/specs", "hooks-spec.md")
prompt = os.path.join(repo, ".hermes/prompts", "hooks-prompt.md")
