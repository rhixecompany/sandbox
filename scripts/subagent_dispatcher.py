...
def build_spec_reviewer_context(task: Task, plan: Plan) -> str:
...
def build_quality_reviewer_context(task: Task, plan: Plan, files: List[str]) -> str:
...
def run_plan(plan_path: str, dry_run: bool = False) -> bool:
    ...
    print(f"\n{'='*60}")
    print(f"FINAL INTEGRATION REVIEW")
    print(f"{'='*60}")
