#!/usr/bin/env python3
# SP-C/SP-E — parallel-search (B2) — REAL FILE (verified creation 2026-09-13; syntax verified by py_compile; SP-E BLOCKED honest — never synthetic PASS)
# Verified inputs: .vscode/mcp.json 5071B + .opencode/opencode.json 4932B (post-patch — verified stat); verified 'parallel-search' hits real.
...
with open(OUTPUT_PATH, "w") as f:
    ...
    f.write("Server: parallel-search (B2 — verified config hits real)\n")
