---
name: suggest-awesome-github-copilot-skills-output-format
title: Suggest Awesome Copilot Skills — Output Format
description: Structured comparison-table format for skill suggestions
version: 1.0.0
