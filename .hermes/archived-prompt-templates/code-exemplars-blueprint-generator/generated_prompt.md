...
> Extracted from `code-exemplars-blueprint-generator.prompt.md`.
...
- Pattern or component type it represents ${INCLUDE_COMMENTS ? "- Key implementation details and coding principles demonstrated" : ""}
