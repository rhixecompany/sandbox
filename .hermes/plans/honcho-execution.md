...
verified_artifacts:
  ...
  spec: .hermes/specs/honcho-spec.md (verified real stat after creation)
  script: .hermes/scripts/honcho"_test_all_tools.py (verified real stat + syntax verified by py_compile)
  config_patch: verified stat change (before/after verified)
  output_file: .hermes/plans/honcho-test-output.md (verified 321B; content BLOCKED — real, never synthetic PASS)
