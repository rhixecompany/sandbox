...
Generated: 2026-09-10T19:49:07.603709+00:00
Logs dir: C:\Users\Alexa\AppData\Local\hermes\logs
Files: 93 | Lines: 441870 | Errors: 14650
...
|---|---|---|---|
| mcp-stderr.log | 216010 | 12366 | other |
| gateway.log | 27810 | 567 | other |
| desktop.log | 4861 | 297 | other |
| gateway-stdio.log | 20654 | 231 | other |
...
- `httpx2.HTTPStatusError: Client error '405 Method Not Allowed' for url 'https://search.parallel.ai/mcp'`
### agent.log.3
- `2026-09-10 17:29:24,165 ERROR agent.chat_completion_helpers: Streaming failed before delivery: Streaming response failed: [502] Upstream error from Nvidia: Service temporarily overloaded`
- `openai.APIError: Streaming response failed: [502] Upstream error from Nvidia: Service temporarily overloaded`
- `2026-09-10 17:34:07,869 ERROR agent.chat_completion_helpers: Streaming failed before delivery: Streaming response failed: [502] Upstream error from Nvidia: Service temporarily overloaded`
- `openai.APIError: Streaming response failed: [502] Upstream error from Nvidia: Service temporarily overloaded`
- `  CRITICAL supply_chain   computer-use\SKILL.md:315      "| `blocked pattern in type text` | You tried to `type` a she"`
### desktop.log
