---
name: "mcp-prompt"
title: "Prompt — Implement MCP (Model Context Protocol) Feature"
---
# Implementation Prompt: mcp
You are implementing the Hermes feature described in docs/features/mcp.md (941 lines).
Steps:
