...
# Phase 1b — Run Python audit (produces .hermes/specs/*.md + *.json)
...
cat .hermes/specs/prompt-library-de-dup-audit.md
cat .hermes/specs/prompt-library-de-dup-audit-data.json | head -n 30
...
cat .hermes/specs/prompt-library-de-dup-action-log.md | tail -n 5
```
...
- [ ] `.hermes/specs/prompt-library-de-dup-and-backup-archive-spec.md` exists
- [ ] `scripts/prompt-library-de-dup-audit.sh` exists
- [ ] `skills/prompt-library-de-dup-and-backup-archive/SKILL.md` exists
- [ ] `.hermes/prompts/prompt-library-de-dup-and-backup-archive.prompt.md` exists (this file)
- [ ] `.hermes/specs/prompt-library-de-dup-action-log.md` exists and lists each destructive action
...
- Audit: `.hermes/specs/prompt-library-de-dup-audit.md` + `.json`
- Log: `.hermes/specs/prompt-library-de-dup-action-log.md`
