...
- Audit .hermes/mcp.json for conflicts with stashed versions; fix conflicts (destructive approved per clarification).
...
- .hermes/plans/subgoal-A-multi-file-protocol-2026-09-14.md (plan artifact — verified created).
- .hermes/specs/subgoal-A-spec-2026-09-14.md (this spec — verified created).
- .hermes/specs/debug-subgoal-spec.md (existing — 2210 B verified real).
- .hermes/plans/debug-subgoal-plan-2026-09-13.md (existing — 4340 B verified real).
- .hermes/plans/debug-run-logs.md (existing — 53152 B verified real — 14 sequential exit codes).
...
- 28 skills verified/mapped (14 direct + 14 mapped — .hermes/specs/skill-verification-evidence.md 2658 B verified real).
...
3. Apply 4 git stashes; resolve conflicts with current .hermes/mcp.json / config.yaml.
