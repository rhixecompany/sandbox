...
Plan reference: .hermes/plans/2026-09-13-comprehensive-hooks-plan.md
...
Read from workspace .hermes/hooks/ (verified by ls):
...
- .hermes/hooks/README.md (to be verified/referenced)
...
A1 Spec: this file (verified path .hermes/specs/01-comprehensive-hooks-spec.md update/add reference)
A2 Plan: .hermes/plans/2026-09-13-comprehensive-hooks-plan.md (written; verified)
...
A7 New framework skeleton: .hermes/hooks/agent-hooks/ + .hermes/hooks/browser-hooks/ directories (spec-level skeletons, not full implementations if time-bound)
...
G3 7 existing hook files present post-execution (ls .hermes/hooks/ — verified real).
