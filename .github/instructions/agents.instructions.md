...
- Location: `.github/prompts/agents/` directory (repository-level) or `agents/` directory (organization/enterprise-level)
...
Spec: .github/prompts/agents/data-processor.agent.md
...
Agent: data-analyst
Spec: .github/prompts/agents/data-analyst.agent.md
Context: projectName=${projectName}, basePath=${basePath}
...
```text
This phase must be performed as the agent "documentation-writer" defined in ".github/prompts/agents/documentation-writer.agent.md".
...
Spec: .github/prompts/agents/security-reviewer.agent.md
...
Agent: test-coverage
Spec: .github/prompts/agents/test-coverage.agent.md
Context: repositoryName=${repositoryName}, prNumber=${prNumber}, basePath=projects/${repositoryName}/pr-${prNumber}
Output: projects/${repositoryName}/pr-${prNumber}/coverage-report.md

Step 3: Aggregate
Agent: review-aggregator
Spec: .github/prompts/agents/review-aggregator.agent.md
Context: repositoryName=${repositoryName}, prNumber=${prNumber}, basePath=projects/${repositoryName}/pr-${prNumber}
...
```text
This phase must be performed as the agent "security-reviewer" defined in ".github/prompts/agents/security-reviewer.agent.md".
...
**Status:** ✅ SUCCESS / ⚠️ SKIPPED / ❌ FAILED **Trigger:** package.json present **Started:** 2026-01-16T10:30:15Z **Completed:** 2026-01-16T10:31:05Z **Duration:** 00:00:50 **Artifacts:** reports/dependency-audit.md **Summary:** [brief agent summary]
```
...
- Location: `.github/prompts/agents/`
...
- [ ] File placed in correct directory (`.github/prompts/agents/` or `agents/`)
...
**Purpose**: Create detailed technical plans and specifications **Tools**: Limited to `['read', 'search', 'edit']` **Approach**: Analyze requirements, create documentation, avoid implementation

### Code Reviewer

**Purpose**: Review code quality and provide feedback **Tools**: `['read', 'search']` only **Approach**: Analyze, suggest improvements, no direct modifications

### Refactoring Specialist

**Purpose**: Improve code structure and maintainability **Tools**: `['read', 'search', 'edit']` **Approach**: Analyze patterns, propose refactorings, implement safely

### Security Auditor

**Purpose**: Identify security issues and vulnerabilities **Tools**: `['read', 'search', 'web']` **Approach**: Scan code, check against OWASP, report findings
