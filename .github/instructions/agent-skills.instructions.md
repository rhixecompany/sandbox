...
applyTo: "**/.github/prompts/skills/**/SKILL.md, **/.claude/skills/**/SKILL.md"
---
...
```
.github/prompts/skills/my-skill/
...
| projects/projects/Bash/Shell | Simple automation tasks             |
...
- [ ] Step 1: Configure environment - see [workflow-setup.md](./references/workflow-setup.md)
- [ ] Step 2: Build project - see [workflow-setup.md](./references/workflow-setup.md)
- [ ] Step 3: Deploy to staging - see [workflow-deployment.md](./references/workflow-deployment.md)
- [ ] Step 4: Run validation - see [workflow-deployment.md](./references/workflow-deployment.md)
- [ ] Step 5: Deploy to production - see [workflow-deployment.md](./references/workflow-deployment.md)
```
