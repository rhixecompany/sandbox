...
metadata:
  ...
  copilot:
    ...
    keybinding: null
  opencode:
    command: opencode /create-github-issue-feature-from-specification
    flags: {}
    help: Create GitHub Issue for feature request from specification file using feature...
  codex:
    model_override: null
...
- Title: Feature name from specification- Description: Problem statement, proposed solution, and context- Labels: feature, enhancement (as appropriate)

## Template References

Templates in `templates/create-github-issue-feature-from-specification/`:- `phases.md`
