...
metadata:
  ...
  copilot:
    ...
    keybinding: null
  opencode:
    command: opencode /fedora-linux-triage
    flags: {}
    help: Triage and resolve Fedora issues with dnf, systemd, and SELinux-aware guidance.
  codex:
    model_override: null
...
Templates in `templates/fedora-linux-triage/`:- `inputs.md`- `instructions.md`- `output_format.md`
