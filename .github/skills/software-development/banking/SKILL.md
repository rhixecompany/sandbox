...
name: banking
title: Banking
description: Use when building and testing banking-domain examples, reference patterns, and prompts.
version: 1.0.0
author: Alexa
license: MIT
metadata:
...
Banking skill for developing and testing fintech applications. Covers account operations, transaction processing, payment integrations (Plaid, Dwolla), and security patterns including idempotency and soft-deletes.
