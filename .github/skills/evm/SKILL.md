---
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Hermes
  Agent
...
- `chainlink` (2026-06-25) — Chainlink LINK tokens, oracle integrations, staking, price feeds, VRF, CCIP
