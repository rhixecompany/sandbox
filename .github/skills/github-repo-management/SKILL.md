...
- When you need to automate or structure workflows for `github-repo-management`.
...
Automated reasoning and workflow tool for `github-repo-management`. Execute multi-step tasks with deterministic quality controls and structured outputs.

## Prerequisites

- Authenticated with GitHub (see `github` skill)
...
- [ ] "Github Repo Management" operations completed successfully
...
Set up required environment, dependencies, and configuration for "Github Repo Management".

### Phase 2: Execution

Run the primary "Github Repo Management" operations according to the defined requirements.
