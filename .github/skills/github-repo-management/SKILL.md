...
if command -v gh &>/dev/null && gh auth status &>/dev/null; then
  ...
  if [ -z "$GITHUB_TOKEN" ]; then
    if [ -f $LOCALAPPDATA/hermes/.env ] && grep -q "^GITHUB_TOKEN=" $LOCALAPPDATA/hermes/.env; then
      GITHUB_TOKEN=$(grep "^GITHUB_TOKEN=" $LOCALAPPDATA/hermes/.env | head -1 | cut -d= -f2 | tr -d '\n\r')
...
- When working with skills\github\github repo management\skill.md tools or services
- When automating or managing skills\github\github repo management\skill.md tasks
- When troubleshooting skills\github\github repo management\skill.md configurations
- **Triggers**: "Skills\github\github Repo Management\skill.md"
