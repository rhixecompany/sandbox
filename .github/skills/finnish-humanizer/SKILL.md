---
author: Alexa
description: Detect and remove AI-generated markers from Finnish text, making it sound
  like a native Finnish speaker wrote it. Use when asked to 'humanize', 'naturalize',
  or 'remove AI feel' from Finnish text, or when editing .md/.txt files containing
  Finnish content. Identifies 26 patterns (12 Finnish-specific + 14 universal) and
  4 style markers.
license: MIT
...
Automated reasoning and workflow tool for `finnish-humanizer`. Execute multi-step tasks with deterministic quality controls and structured outputs.

## When to Use

- Use this skill when working with finnish humanizer tasks
- Triggered by: `finnish-humanizer` related operations
...
Set up required environment, dependencies, and configuration for Finnish Humanizer.

### Phase 2: Execution

Run the primary Finnish Humanizer operations according to the defined requirements.
