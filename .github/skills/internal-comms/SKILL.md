---
author: Alexa
description: Use when working with Internal Comms.
license: MIT
metadata:
  hermes:
    tags:
...
Automated reasoning and workflow tool for `internal-comms`. Execute multi-step tasks with deterministic quality controls and structured outputs.

## Goal
Provide comprehensive guidance for Internal Comms workflows.
...
## When to Use
When working with Internal Comms in Hermes workflows.
