...
- When you need to automate or structure workflows for `hermes-s6-container-supervision`.
...
Automated reasoning and workflow tool for `hermes-s6-container-supervision`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- [ ] "Hermes S6 Container Supervision" operations completed successfully
...
Set up required environment, dependencies, and configuration for "Hermes S6 Container Supervision".

### Phase 2: Execution

Run the primary "Hermes S6 Container Supervision" operations according to the defined requirements.
