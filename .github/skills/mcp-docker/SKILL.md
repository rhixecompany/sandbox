...
Automated reasoning and workflow tool for `mcp-docker`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- When you need to perform MCP Docker — Container Management & MCP Tool Gateway operations or tasks
- When managing MCP Docker — Container Management & MCP Tool Gateway infrastructure or configurations
- When automating or debugging MCP Docker — Container Management & MCP Tool Gateway workflows
- **Triggers**: "mcp docker — container management & mcp tool gateway" required for a project
