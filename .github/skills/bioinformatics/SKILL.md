...
Automated reasoning and workflow tool for `bioinformatics`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- [ ] "Bioinformatics" operations completed successfully
...
- asked about bioinformatics, genomics, sequencing, variant calling, gene expression, single-cell analysis, protein structure, pharmacogenomics, metagenomics, phylogenetics, or any computational biology task
- **Triggers**: ""bioinformatics"" required for a project

## Workflow

### Phase 1: Preparation

Set up required environment, dependencies, and configuration for "Bioinformatics".

### Phase 2: Execution

Run the primary "Bioinformatics" operations according to the defined requirements.
