...
- When you need to automate or structure workflows for `mindstudio-wrapper`.
...
Automated reasoning and workflow tool for `mindstudio-wrapper`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
Set up required environment, dependencies, and configuration for Mindstudio Wrapper.

### Phase 2: Execution

Run the primary Mindstudio Wrapper operations according to the defined requirements.
