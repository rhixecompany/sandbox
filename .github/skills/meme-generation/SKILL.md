...
Automated reasoning and workflow tool for `meme-generation`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- [ ] "Meme Generation" operations completed successfully
...
Set up required environment, dependencies, and configuration for "Meme Generation".

### Phase 2: Execution

Run the primary "Meme Generation" operations according to the defined requirements.
