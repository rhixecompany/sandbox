...
Automated reasoning and workflow tool for `maps`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
Script path: `~/AppData/Local/hermes/skills/maps/scripts/maps_client.py`

## Commands

```bash
MAPS=$LOCALAPPDATA/hermes/skills/maps/scripts/maps_client.py
```
...
```bash
python3 $LOCALAPPDATA/hermes/skills/maps/scripts/maps_client.py search "Statue of Liberty"
# Should return lat ~40.689, lon ~-74.044

python3 $LOCALAPPDATA/hermes/skills/maps/scripts/maps_client.py nearby --near "Times Square" --category restaurant --limit 3
