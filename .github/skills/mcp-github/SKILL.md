...
Automated reasoning and workflow tool for `mcp-github`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- When you need to perform MCP GitHub — Repository & Code Management operations or tasks
- When managing MCP GitHub — Repository & Code Management infrastructure or configurations
- When automating or debugging MCP GitHub — Repository & Code Management workflows
- **Triggers**: "mcp github — repository & code management" required for a project
