...
Automated reasoning and workflow tool for `mcp-playwright`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- When you need to perform MCP Playwright — Browser Automation operations or tasks
- When managing MCP Playwright — Browser Automation infrastructure or configurations
- When automating or debugging MCP Playwright — Browser Automation workflows
- **Triggers**: "mcp playwright — browser automation" required for a project
