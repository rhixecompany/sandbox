---
author: Alexa
description: Use when working with Mcp Security Audit.
license: MIT
metadata:
  hermes:
    tags:
...
Automated reasoning and workflow tool for `mcp-security-audit`. Execute multi-step tasks with deterministic quality controls and structured outputs.

## Goal
Provide comprehensive guidance for Mcp Security Audit workflows.
...
## When to Use
When working with Mcp Security Audit in Hermes workflows.
