...
Automated reasoning and workflow tool for `ocr-and-documents`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- When working with ocr and documents tools or integrations
- When automating or managing ocr and documents tasks
- When troubleshooting ocr and documents configurations
- **Triggers**: "Ocr And Documents", "ocr and documents" related operations
...
Perform the ocr and documents operations following the skill instructions.
