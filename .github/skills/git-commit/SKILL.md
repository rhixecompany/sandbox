...
description: 'Execute git commit with conventional commit message analysis, intelligent
  ...
  git commit, or mentions ''/commit''. Supports: (1) Auto-detecting type and scope
  from changes, (2) Generating conventional commit messages from diff, (3) Interactive
...
- user asks to commit changes, create a
  git commit, or mentions ''/commit''
- **Triggers**: "git commit" required for a project
