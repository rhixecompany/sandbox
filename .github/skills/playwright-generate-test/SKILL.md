---
author: Alexa
description: Use when working with Playwright Generate Test.
license: MIT
metadata:
  hermes:
    tags:
...
Automated reasoning and workflow tool for `playwright-generate-test`. Execute multi-step tasks with deterministic quality controls and structured outputs.

## Goal
Provide comprehensive guidance for Playwright Generate Test workflows.
...
## When to Use
When working with Playwright Generate Test in Hermes workflows.
