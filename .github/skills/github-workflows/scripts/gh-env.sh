...
#   source skills/github/github-workflows/scripts/gh-env.sh
#
...
[ "$GH_AUTH_METHOD" = "none" ] && echo "Not authenticated — see references/auth-setup.md in the github-workflows skill"
