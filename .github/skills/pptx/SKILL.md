...
name: pptx
title: "Pptx"
description: "Use when working with Pptx."
version: 1.0.0
author: Alexa
license: MIT
tags: [tools]
...
Automated reasoning and workflow tool for `pptx`. Execute multi-step tasks with deterministic quality controls and structured outputs.

## Goal
Provide comprehensive guidance for Pptx workflows.
...
## When to Use
When working with Pptx in Hermes workflows.
