...
Automated reasoning and workflow tool for `yuanbao`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- When working with yuanbao tools or integrations
- When automating or managing yuanbao tasks
- When troubleshooting yuanbao configurations
- **Triggers**: "Yuanbao", "yuanbao" related operations
...
Perform the yuanbao operations following the skill instructions.
