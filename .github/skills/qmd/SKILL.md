...
Automated reasoning and workflow tool for `qmd`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- [ ] "Qmd" operations completed successfully
...
Set up required environment, dependencies, and configuration for "Qmd".

### Phase 2: Execution

Run the primary "Qmd" operations according to the defined requirements.
