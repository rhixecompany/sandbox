...
- When you need to automate or structure workflows for `shopify`.
...
Automated reasoning and workflow tool for `shopify`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
Set up required environment, dependencies, and configuration for "Shopify".

### Phase 2: Execution

Run the primary "Shopify" operations according to the defined requirements.
