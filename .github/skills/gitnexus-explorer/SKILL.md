...
Automated reasoning and workflow tool for `gitnexus-explorer`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- [ ] "Gitnexus Explorer" operations completed successfully
...
Set up required environment, dependencies, and configuration for "Gitnexus Explorer".

### Phase 2: Execution

Run the primary "Gitnexus Explorer" operations according to the defined requirements.
