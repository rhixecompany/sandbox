...
Automated reasoning and workflow tool for `touchdesigner-mcp`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- When working with skills\creative\touchdesigner mcp\skill.md tools or services
- When automating or managing skills\creative\touchdesigner mcp\skill.md tasks
- When troubleshooting skills\creative\touchdesigner mcp\skill.md configurations
- **Triggers**: "Skills\creative\touchdesigner Mcp\skill.md"
