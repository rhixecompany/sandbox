---
author: Hermes Agent
description: Generate ASCII art diagrams using PlantUML text mode. Use when user asks
  to create ASCII diagrams, text-based diagrams, terminal-friendly diagrams, or mentions
  plantuml ascii, text diagram, ascii art diagram.
license: MIT
metadata:
  hermes:
    tags:
...
- Use this skill when working with plantuml ascii tasks
- Triggered by: `plantuml-ascii` related operations
...
| Skill | Purpose |
|-------|---------|
| `mermaid-diagrams` | Alternative diagram syntax for comparison |

## Verification Checklist

- [ ] PlantUML installed or Java JAR available
- [ ] Terminal supports UTF-8 with fixed-width font
- [ ] Diagram type selected (sequence, class, flowchart, etc.)
- [ ] ASCII output generated without errors
- [ ] Diagram renders correctly in target viewer

## Pitfalls

- Garbled Unicode characters indicate missing UTF-8 support or wrong font
- Misaligned diagrams are caused by proportional fonts; use fixed-width
- Complex diagrams may exceed terminal width; simplify or use smaller scale

## Workflow

### Phase 1: Preparation

Set up required environment, dependencies, and configuration for PlantUML ASCII.

### Phase 2: Execution

Run the primary PlantUML ASCII operations according to the defined requirements.
