...
- When you need to automate or structure workflows for `here.now`.
...
Automated reasoning and workflow tool for `here.now`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- [ ] "Here.Now" operations completed successfully
...
Set up required environment, dependencies, and configuration for "Here.Now".

### Phase 2: Execution

Run the primary "Here.Now" operations according to the defined requirements.
