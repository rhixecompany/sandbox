---
author: Alexa
description: Aspire skill covering the Aspire CLI, AppHost orchestration, service
...
Automated reasoning and workflow tool for `aspire`. Execute multi-step tasks with deterministic quality controls and structured outputs.

## When to Use

- Use this skill when working with aspire tasks
- Triggered by: `aspire` related operations
...
Set up required environment, dependencies, and configuration for Aspire.

### Phase 2: Execution

Run the primary Aspire operations according to the defined requirements.
