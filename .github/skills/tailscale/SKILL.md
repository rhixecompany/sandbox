...
Automated reasoning and workflow tool for `tailscale`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- [ ] "Tailscale Tailnet Management" operations completed successfully
...
Set up required environment, dependencies, and configuration for "Tailscale Tailnet Management".

### Phase 2: Execution

Run the primary "Tailscale Tailnet Management" operations according to the defined requirements.
