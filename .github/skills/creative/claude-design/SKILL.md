...
- When you need to use claude design for creative or design tasks
- When a project requires claude design output or integration
- When automating or generating claude design-style content
- **Triggers**: "Claude Design" required for a project

## Overview

The Skills\creative\claude Design\skill.md skill provides tools and workflows for managing skills\creative\claude design\skill.md operations efficiently.

## Verification Checklist

- [ ] Environment and dependencies are properly configured
- [ ] Claude Design output was generated successfully
