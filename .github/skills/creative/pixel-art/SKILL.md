...
| Skill | Purpose |
|-------|---------|
| `terminal` | Run pixel_art.py and pixel_art_video.py scripts |
| `clarify` | Interactive style and animation selection |
...
- **`scripts/palettes.py`** — 28 named hardware palettes (see `references/palettes.md`)
- **`scripts/pixel_art.py`** — Photo → pixel-art PNG (Floyd-Steinberg dithering)
- **`scripts/pixel_art_video.py`** — Pixel-art PNG → animated MP4/GIF
...
The Skills\creative\pixel Art\skill.md skill provides tools and workflows for managing skills\creative\pixel art\skill.md operations efficiently.

## Verification Checklist

- [ ] Environment and dependencies are properly configured
- [ ] Pixel Art output was generated successfully
