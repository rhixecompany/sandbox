...
- When you need to use excalidraw for creative or design tasks
- When a project requires excalidraw output or integration
- When automating or generating excalidraw-style content
- **Triggers**: "Excalidraw" required for a project

## Overview

The Skills\creative\excalidraw\skill.md skill provides tools and workflows for managing skills\creative\excalidraw\skill.md operations efficiently.
...
- [ ] Excalidraw output was generated successfully
