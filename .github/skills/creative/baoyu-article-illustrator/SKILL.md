...
| Skill | Purpose |
|-------|---------|
| `image_generate` | Generate illustrations from prompts |
| `vision_analyze` | Analyze reference images for style/palette extraction |
| `clarify` | Interactive settings confirmation |
| `write_file` | Save prompt files and outlines |
...
The Skills\creative\baoyu Article Illustrator\skill.md skill provides tools and workflows for managing skills\creative\baoyu article illustrator\skill.md operations efficiently.

## Verification Checklist

- [ ] Environment and dependencies are properly configured
- [ ] Baoyu Article Illustrator output was generated successfully
