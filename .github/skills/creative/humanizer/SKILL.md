...
- `references/anti-patterns.md` — Anti-Patterns Checklist: NEVER DO patterns (soulless writing, content inflation, vocabulary, style, chatbot artifacts, wordiness)
- `references/patterns-reference.md` — 24 AI Writing Anti-Patterns with decision trees and before/after examples

## When to Use

- When you need to use humanizer for creative or design tasks
- When a project requires humanizer output or integration
- When automating or generating humanizer-style content
- **Triggers**: "Humanizer" required for a project
...
Perform the skills\creative\humanizer\skill.md operations following the skill instructions.
...
The Skills\creative\humanizer\skill.md skill provides tools and workflows for managing skills\creative\humanizer\skill.md operations efficiently.
...
- [ ] Humanizer output was generated successfully
