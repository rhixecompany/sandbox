...
Automated reasoning and workflow tool for `duckduckgo-search`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- [ ] "Duckduckgo Search" operations completed successfully
...
- When you need to perform "Duckduckgo Search" operations or tasks
- When managing "Duckduckgo Search" infrastructure or configurations
- When automating or debugging "Duckduckgo Search" workflows
- **Triggers**: ""duckduckgo search"" required for a project
