...
Automated reasoning and workflow tool for `sherlock`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- [ ] "Sherlock" operations completed successfully
...
Set up required environment, dependencies, and configuration for "Sherlock".

### Phase 2: Execution

Run the primary "Sherlock" operations according to the defined requirements.
