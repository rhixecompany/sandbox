...
Wrapper skill for the `hello.py` script in `~/AppData/Local/hermes/scripts/`.

The script is located at `~/AppData/Local/hermes/scripts/hello.py`.

## Script Reference

**Location:** `~/AppData/Local/hermes/scripts/hello.py`
...
```bash
cd ~/AppData/Local/hermes/scripts && python hello.py [options]
```

## When to Use

- When you need to perform hello as part of your workflow
