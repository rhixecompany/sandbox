---
name: busha-api-quickstart
title: "Busha API Quickstart Guide"
...
author: Hermes Agent
license: MIT
tags: [busha, api, quickstart, africa, stablecoins, business]
---
# Busha API Quickstart Guide
...
- **Idempotency key reuse** → Causes REFERENCE_ALREADY_EXISTS; generate unique per request
