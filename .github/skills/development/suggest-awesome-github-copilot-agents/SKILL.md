...
description: Suggest relevant GitHub Copilot Custom Agents files from the awesome-copilot
  ...
  with existing custom agents in this repository, and identifying outdated agents
  that need updates.
license: MIT
...
- Use this skill when working with suggest awesome github copilot agents tasks
- Triggered by: `suggest-awesome-github-copilot-agents` related operations
