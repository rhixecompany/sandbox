...
description: Create new Agent Skills for GitHub Copilot from prompts or by duplicating
  ...
  a skill', or when building specialized AI capabilities with bundled resources. Generates
  SKILL.md files with proper frontmatter, directory structure, and optional scripts/references/assets
  folders.
license: MIT
