...
name: prime-factors
title: Prime Factors
description: Script for Prime Factors operations
version: 1.0.0
author: Hermes Agent
license: MIT
tags:
...
Wrapper skill for the `prime_factors.py` script in `~/AppData/Local/hermes/scripts/`.

The script is located at `~/AppData/Local/hermes/scripts/prime_factors.py`.

## Script Reference

**Location:** `~/AppData/Local/hermes/scripts/prime_factors.py`

**Type:** Python

**Usage:**
```bash
python prime_factors.py [options]
```

Run from the scripts directory or use the full path:
```bash
cd ~/AppData/Local/hermes/scripts && python prime_factors.py [options]
```

## When to Use

- When you need to perform prime factors as part of your workflow
