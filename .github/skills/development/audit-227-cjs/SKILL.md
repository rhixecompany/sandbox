...
name: audit-227-cjs
title: Audit 227
description: Audit script for 227 analysis
version: 1.0.0
author: Hermes Agent
license: MIT
tags:
...
Wrapper skill for the `audit-227.cjs` script in `~/AppData/Local/hermes/scripts/`.

The script is located at `~/AppData/Local/hermes/scripts/audit-227.cjs`.

## Script Reference

**Location:** `~/AppData/Local/hermes/scripts/audit-227.cjs`

**Type:** Node.js (CommonJS)

**Usage:**
```bash
node audit-227.cjs [options]
```

Run from the scripts directory or use the full path:
```bash
cd ~/AppData/Local/hermes/scripts && node audit-227.cjs [options]
```

## When to Use

- When you need to perform audit 227 as part of your workflow
