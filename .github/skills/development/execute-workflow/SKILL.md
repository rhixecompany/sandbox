...
description: Script for Execute Workflow operations
version: 1.0.0
author: Hermes Agent
license: MIT
tags:
...
Wrapper skill for the `execute_workflow.py` script in `~/AppData/Local/hermes/scripts/`.

The script is located at `~/AppData/Local/hermes/scripts/execute_workflow.py`.

## Script Reference

**Location:** `~/AppData/Local/hermes/scripts/execute_workflow.py`
...
```bash
cd ~/AppData/Local/hermes/scripts && python execute_workflow.py [options]
```

## When to Use

- When you need to perform execute workflow as part of your workflow
