...
## Purpose
Agents read the skill `description` field to decide whether to load a skill for a given task. Make it answer: "Should I read this skill right now?"
