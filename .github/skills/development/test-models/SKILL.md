...
name: test-models
title: Test Models
description: Tests LLM model availability and response quality
version: 1.0.0
author: Hermes Agent
license: MIT
tags:
...
Wrapper skill for the `test_models.py` script in `~/AppData/Local/hermes/scripts/`.

The script is located at `~/AppData/Local/hermes/scripts/test_models.py`.

## Script Reference

**Location:** `~/AppData/Local/hermes/scripts/test_models.py`
...
```bash
cd ~/AppData/Local/hermes/scripts && python test_models.py [options]
```

## When to Use

- When you need to perform test models as part of your workflow
