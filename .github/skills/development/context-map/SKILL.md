---
author: Hermes Agent
description: Use when analyzing and documenting the context boundaries, dependencies, and data flows between components in a complex system. Use during architecture review, onboarding to unfamiliar codebases, or debugging cross-component issues.
license: MIT
metadata:
  hermes:
    tags: [imported, architecture, documentation, context-mapping, onboarding]
name: context-map
tags:
- architecture
- documentation
...
- `architecture-blueprint-generator` — Full architecture documentation
- `codemap` — Component hierarchy generation
- `systematic-debugging` — Cross-component issue tracing

## Usage Examples

```bash
# Generate context map for a codebase
context-map --input ./src --output docs/context-map.md

# Dry run to see what would be analyzed
context-map --input ./src --dry-run

# Focus on specific component
context-map --input ./src --component auth-service --output docs/auth-context.md
```

## Error Handling

- **Component not found:** Warns, continues with available components
- **Import analysis failed:** Falls back to file structure heuristic
...
- `references/context-mapping-patterns.md` — Common patterns and anti-patterns
- `references/boundary-classification.md` — Detailed boundary type definitions
- `references/risk-catalog.md` — Coupling risk patterns and mitigation strategies