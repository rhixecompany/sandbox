...
description: "Use when working with Microsoft Docs."
version: 1.0.0
author: Alexa
license: MIT
tags: [tools]
...
## Goal
Provide comprehensive guidance for Microsoft Docs workflows.
...
## When to Use
When working with Microsoft Docs in Hermes workflows.
