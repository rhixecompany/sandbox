---
name: audit-vscode-config-v2
title: Audit Vscode Config V2
description: Audits vscode config v2 for issues and quality concerns
version: 1.0.0
author: Hermes Agent
license: MIT
tags:
...
Wrapper skill for the `audit_vscode_config_v2.py` script in `~/AppData/Local/hermes/scripts/`.

The script is located at `~/AppData/Local/hermes/scripts/audit_vscode_config_v2.py`.

## Script Reference

**Location:** `~/AppData/Local/hermes/scripts/audit_vscode_config_v2.py`

**Type:** Python

**Usage:**
```bash
python audit_vscode_config_v2.py [options]
```

Run from the scripts directory or use the full path:
```bash
cd ~/AppData/Local/hermes/scripts && python audit_vscode_config_v2.py [options]
```

## When to Use

- When you need to perform audit vscode config v2 as part of your workflow
