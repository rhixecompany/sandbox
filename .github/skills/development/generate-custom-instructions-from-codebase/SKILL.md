...
- Use this skill when working with generate custom instructions from codebase tasks
- Triggered by: `generate-custom-instructions-from-codebase` related operations
