---
name: benchmark-run-20260710
title: Benchmark Run 20260710
description: Benchmarks LLM models for performance comparison
version: 1.0.0
author: Hermes Agent
license: MIT
tags:
...
Wrapper skill for the `benchmark_run_20260710.log` script in `~/AppData/Local/hermes/scripts/`.

The script is located at `~/AppData/Local/hermes/scripts/benchmark_run_20260710.log`.

## Script Reference

**Location:** `~/AppData/Local/hermes/scripts/benchmark_run_20260710.log`

**Type:** benchmark_run_20260710.log

**Usage:**
```bash
python benchmark_run_20260710.log [options]
```

Run from the scripts directory or use the full path:
```bash
cd ~/AppData/Local/hermes/scripts && python benchmark_run_20260710.log [options]
```

## When to Use

- When you need to perform benchmark run 20260710 as part of your workflow
...
- When the environment does not support benchmark_run_20260710.log execution
