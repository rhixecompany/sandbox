...
name: hello-world
title: Hello World
description: Simple example script for testing purposes
version: 1.0.0
author: Hermes Agent
license: MIT
tags:
...
Wrapper skill for the `hello_world.py` script in `~/AppData/Local/hermes/scripts/`.

The script is located at `~/AppData/Local/hermes/scripts/hello_world.py`.

## Script Reference

**Location:** `~/AppData/Local/hermes/scripts/hello_world.py`

**Type:** Python

**Usage:**
```bash
python hello_world.py [options]
```

Run from the scripts directory or use the full path:
```bash
cd ~/AppData/Local/hermes/scripts && python hello_world.py [options]
```

## When to Use

- When you need to perform hello world as part of your workflow
