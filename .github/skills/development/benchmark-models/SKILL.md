...
Wrapper skill for the `benchmark_models.py` script in `~/AppData/Local/hermes/scripts/`.

The script is located at `~/AppData/Local/hermes/scripts/benchmark_models.py`.

## Script Reference

**Location:** `~/AppData/Local/hermes/scripts/benchmark_models.py`
...
```bash
cd ~/AppData/Local/hermes/scripts && python benchmark_models.py [options]
```

## When to Use

- When you need to perform benchmark models as part of your workflow
