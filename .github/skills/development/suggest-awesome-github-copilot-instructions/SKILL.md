...
description: Suggest relevant GitHub Copilot instruction files from the awesome-copilot
  ...
  with existing instructions in this repository, and identifying outdated instructions
  that need updates.
license: MIT
...
- Use this skill when working with suggest awesome github copilot instructions tasks
- Triggered by: `suggest-awesome-github-copilot-instructions` related operations
