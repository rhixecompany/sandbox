...
- When you need to automate or structure workflows for `siyuan`.
...
Automated reasoning and workflow tool for `siyuan`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- [ ] "Siyuan" operations completed successfully
...
Set up required environment, dependencies, and configuration for "Siyuan".

### Phase 2: Execution

Run the primary "Siyuan" operations according to the defined requirements.
