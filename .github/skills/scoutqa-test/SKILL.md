---
author: Alexa
description: Use when working with Scoutqa Test.
license: MIT
metadata:
  hermes:
    tags:
...
Automated reasoning and workflow tool for `scoutqa-test`. Execute multi-step tasks with deterministic quality controls and structured outputs.

## Goal
Provide comprehensive guidance for Scoutqa Test workflows.
...
## When to Use
When working with Scoutqa Test in Hermes workflows.
