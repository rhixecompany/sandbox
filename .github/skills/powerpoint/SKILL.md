...
Automated reasoning and workflow tool for `powerpoint`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- When working with powerpoint tools or integrations
- When automating or managing powerpoint tasks
- When troubleshooting powerpoint configurations
- **Triggers**: "Powerpoint", "powerpoint" related operations
...
Perform the powerpoint operations following the skill instructions.
