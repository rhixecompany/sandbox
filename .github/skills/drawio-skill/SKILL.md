---
author: Alexa
description: Use when working with Drawio Skill.
license: MIT
metadata:
  hermes:
    category: creative
...
## Goal
Provide comprehensive guidance for Drawio Skill workflows.
...
## When to Use
When working with Drawio Skill in Hermes workflows.
