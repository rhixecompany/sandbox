...
Automated reasoning and workflow tool for `research-toolkit`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
Set up required environment, dependencies, and configuration for Research Toolkit (find, monitor, write).

### Phase 2: Execution

Run the primary Research Toolkit (find, monitor, write) operations according to the defined requirements.
