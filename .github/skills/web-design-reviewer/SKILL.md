...
description: This skill enables visual inspection of websites running locally or remotely
  ...
  'check the UI', 'fix the layout', 'find design problems'. Detects issues with responsive
  design, accessibility, visual consistency, and layout breakage, then performs fixes
...
Automated reasoning and workflow tool for `web-design-reviewer`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- When you need to perform Web Design Reviewer operations or tasks
- When managing Web Design Reviewer infrastructure or configurations
- When automating or debugging Web Design Reviewer workflows
- **Triggers**: "web design reviewer" required for a project
