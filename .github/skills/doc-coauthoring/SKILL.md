---
author: Alexa
description: Use when working with Doc Coauthoring.
license: MIT
metadata:
  hermes:
    tags:
...
Automated reasoning and workflow tool for `doc-coauthoring`. Execute multi-step tasks with deterministic quality controls and structured outputs.

## Goal
Provide comprehensive guidance for Doc Coauthoring workflows.
...
## When to Use
When working with Doc Coauthoring in Hermes workflows.
