...
- When you need to automate or structure workflows for `telephony`.
...
Automated reasoning and workflow tool for `telephony`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- [ ] "Telephony" operations completed successfully
...
Set up required environment, dependencies, and configuration for "Telephony".

### Phase 2: Execution

Run the primary "Telephony" operations according to the defined requirements.
