...
- **For deletion/verification tasks** — if the user asks to "delete all X" or "verify all Y", this is a direct execution task, not a brainstorming task. Execute directly without invoking the brainstorming workflow.
