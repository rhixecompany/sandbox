---
author: Alexa
description: "Build Fluent UI Blazor applications: components, theming, layout patterns."
license: MIT
...
Automated reasoning and workflow tool for `fluentui-blazor`. Execute multi-step tasks with deterministic quality controls and structured outputs.

## When to Use

- Use this skill when working with fluentui blazor tasks
- Triggered by: `fluentui-blazor` related operations
...
Set up required environment, dependencies, and configuration for Fluentui Blazor.

### Phase 2: Execution

Run the primary Fluentui Blazor operations according to the defined requirements.
