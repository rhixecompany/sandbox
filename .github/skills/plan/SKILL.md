...
Automated reasoning and workflow tool for `plan`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- When you need to perform Plan operations or tasks
- When managing Plan infrastructure or configurations
- When automating or debugging Plan workflows
- **Triggers**: "plan" required for a project
