...
- When performing kanban orchestrator operations or tasks
- When managing kanban orchestrator infrastructure or configurations
- When automating or debugging kanban orchestrator workflows
- **Triggers**: "set up devops/kanban-orchestrator", "configure kanban orchestrator", "debug kanban orchestrator issue"
...
Perform the kanban orchestrator operations following the instructions in this skill.
...
- [ ] Kanban Orchestrator operations completed successfully
...
Kanban Orchestrator is a skill for handling kanban orchestrator tasks and automation workflows. Use this skill when you need to perform kanban orchestrator operations efficiently.
