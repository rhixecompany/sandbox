...
- Subscriptions persist to `~/AppData/Local/hermes/webhook_subscriptions.json`

## How It Works

1. `hermes webhook subscribe` writes to `~/AppData/Local/hermes/webhook_subscriptions.json`
...
3. **Check gateway logs:** `grep webhook ~/AppData/Local/hermes/logs/gateway.log | tail -20`
...
- When performing webhook subscriptions operations or tasks
- When managing webhook subscriptions infrastructure or configurations
- When automating or debugging webhook subscriptions workflows
- **Triggers**: "set up devops/webhook-subscriptions", "configure webhook subscriptions", "debug webhook subscriptions issue"
...
Perform the webhook subscriptions operations following the instructions in this skill.
...
- [ ] Webhook Subscriptions operations completed successfully
...
Webhook Subscriptions is a skill for handling webhook subscriptions tasks and automation workflows. Use this skill when you need to perform webhook subscriptions operations efficiently.
