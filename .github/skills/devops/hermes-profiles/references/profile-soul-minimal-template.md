...
Use this template when creating or consolidating profile-specific SOUL.md files. The key principle: **profile-specific files contain identity only; standards reference parent (~/AppData/Local/hermes/SOUL.md).**
...
**See parent SOUL.md (~/AppData/Local/hermes/SOUL.md) for shared standards:**
...
- ~/AppData/Local/hermes/profiles/[profile-name]/config.yaml — toolsets, MCP servers, hooks
- ~/AppData/Local/hermes/memories/USER.md — user identity, active model, providers
```
...
- [ ] No duplication of parent standards (no copy-paste from ~/AppData/Local/hermes/SOUL.md)
