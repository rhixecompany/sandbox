...
### Step 3 — Fix MSYS path translation in hook.sh
...
On MSYS, `pwd` returns `/c/Users/...` which gets double-translated to `C:\c\Users\...` when passed to Windows Python. Fix:
...
- `pwd -W` returns native Windows path (`C:/Users/...`)
