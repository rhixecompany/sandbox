---
author: Alexa
description: Create Agent Users in Microsoft Entra ID from Agent Identities, enabling
  AI agents to act as digital workers with user identity capabilities in Microsoft
  365 and Azure environments.
license: MIT
name: entra-agent-user
tags:
- imported
title: Entra Agent User
version: 1.0.0
...
- Use this skill when working with entra agent user tasks
- Triggered by: `entra-agent-user` related operations
