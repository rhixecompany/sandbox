...
**Time Delay Formula:** $$t_d = 1.1 \times R_A \times C_1$$
...
**Charging Equation:** $$C_1 \frac{dV_{C1}}{dt} = \frac{V_{CC} - V_{(0-)}}{R_A + R_B} \quad (1)$$
...
**Discharging Equation:** $$C_1 \frac{dV_{C1}}{dt} + \frac{1}{R_A + R_B} V_{C1} = 0 \quad (6)$$
