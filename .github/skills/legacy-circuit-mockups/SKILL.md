---
author: Hermes Agent
description: Generate breadboard circuit mockups and visual diagrams using HTML5 Canvas
  drawing techniques.
license: MIT
metadata:
  hermes:
...
Automated reasoning and workflow tool for `legacy-circuit-mockups`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
| Skill | Purpose |
|-------|---------|
| `canvas-design` | Visual design and layout for circuit diagrams |

## Verification Checklist

- [ ] Circuit components identified and placed on breadboard
- [ ] Wiring connections verified against schematic
- [ ] Component orientations correct (pin 1, polarity)
- [ ] Diagram exported as PNG/SVG
- [ ] Reference docs consulted for component specs
...
- Incorrect component orientation damages real hardware
- Missing power/ground connections cause non-functional circuits
- Not verifying against datasheets leads to wrong pinouts
