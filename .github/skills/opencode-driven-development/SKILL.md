...
- [ ] OpenCode-Driven Development operations completed successfully
...
- When you need to perform OpenCode-Driven Development operations or tasks
- When managing OpenCode-Driven Development infrastructure or configurations
- When automating or debugging OpenCode-Driven Development workflows
- **Triggers**: "opencode-driven development" required for a project

## Workflow

### Phase 1: Preparation

Set up required environment, dependencies, and configuration for OpenCode-Driven Development.

### Phase 2: Execution

Run the primary OpenCode-Driven Development operations according to the defined requirements.
