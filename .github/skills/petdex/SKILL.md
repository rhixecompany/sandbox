...
Automated reasoning and workflow tool for `petdex`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
Set up required environment, dependencies, and configuration for Petdex.

### Phase 2: Execution

Run the primary Petdex operations according to the defined requirements.
