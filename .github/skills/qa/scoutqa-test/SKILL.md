...
**Starting a new test?** → Use `scoutqa --url --prompt` **Agent needs more context?** → Use `scoutqa send-message` (see "Following Up on Stuck Executions")
...
Execution ID: `019b831d-xxx` View Live: https://scoutqa.ai/t/019b831d-xxx
