---
author: Alexa
description: Use when working with Slack Gif Creator.
license: MIT
metadata:
  hermes:
    tags:
...
## Goal
Provide comprehensive guidance for Slack Gif Creator workflows.
...
## When to Use
When working with Slack Gif Creator in Hermes workflows.
