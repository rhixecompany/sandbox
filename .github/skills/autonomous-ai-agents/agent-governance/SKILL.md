...
| Skill | Purpose |
|-------|---------|
| `systematic-debugging` | Diagnose governance policy failures |
| `log-analysis-and-triage` | Analyze agent audit trails |

## Verification Checklist

- [ ] Governance policies defined and tested
- [ ] Content filters catch sensitive patterns
- [ ] Rate limiting behavior verified
- [ ] Audit trail captures all events
- [ ] Policy composition tested (most-restrictive-wins)

## Pitfalls

- Overly restrictive policies block legitimate agent actions
- Missing audit trails make compliance verification impossible
- Not testing policy composition leads to unexpected permissive behavior
