---
author: Hermes Agent
description: Use Qwen Code v0.17.0 (Bun-installed) as an ACPX coding agent via OpenRouter
  API key for headless coding tasks.
license: MIT
metadata:
  hermes:
    tags:
...
| Skill | Purpose |
|-------|---------|
| `copilot-cli` | Alternative ACPX coding agent |
| `opencode` | Fallback coding agent |
