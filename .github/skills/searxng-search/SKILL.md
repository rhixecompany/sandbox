...
Automated reasoning and workflow tool for `searxng-search`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- [ ] "Searxng Search" operations completed successfully
...
- When you need to perform "Searxng Search" operations or tasks
- When managing "Searxng Search" infrastructure or configurations
- When automating or debugging "Searxng Search" workflows
- **Triggers**: ""searxng search"" required for a project
