---
author: Alexa
description: Use when working with Nuget Manager.
license: MIT
metadata:
  hermes:
    tags:
...
Automated reasoning and workflow tool for `nuget-manager`. Execute multi-step tasks with deterministic quality controls and structured outputs.

## Goal
Provide comprehensive guidance for Nuget Manager workflows.
...
## When to Use
When working with Nuget Manager in Hermes workflows.
