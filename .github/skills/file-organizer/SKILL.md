---
author: Alexa
description: Use when working with File Organizer.
license: MIT
metadata:
  hermes:
    tags:
...
Automated reasoning and workflow tool for `file-organizer`. Execute multi-step tasks with deterministic quality controls and structured outputs.

## Goal
Provide comprehensive guidance for File Organizer workflows.
...
## When to Use
When working with File Organizer in Hermes workflows.
