---
author: Hermes Agent
description: This skill should be used when the user asks about "Next.js with Bun",
  "Bun and Next", "running Next.js on Bun", "Next.js development with Bun", "create-next-app
  with Bun", or building Next.js applications using Bun as the runtime.
license: MIT
metadata:
  hermes:
