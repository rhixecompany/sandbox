...
Automated reasoning and workflow tool for `pnpm-package-manager`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
Set up required environment, dependencies, and configuration for "pnpm — Fast Node Package Manager".

### Phase 2: Execution

Run the primary "pnpm — Fast Node Package Manager" operations according to the defined requirements.
