---
author: Alexa
description: Use when working with Documentation Writer.
license: MIT
metadata:
  hermes:
    tags:
...
Automated reasoning and workflow tool for `documentation-writer`. Execute multi-step tasks with deterministic quality controls and structured outputs.

## Goal
Provide comprehensive guidance for Documentation Writer workflows.
...
## When to Use
When working with Documentation Writer in Hermes workflows.
