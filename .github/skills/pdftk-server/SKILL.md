...
Automated reasoning and workflow tool for `pdftk-server`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
Set up required environment, dependencies, and configuration for "Pdftk Server".

### Phase 2: Execution

Run the primary "Pdftk Server" operations according to the defined requirements.
