...
Automated reasoning and workflow tool for `mcp-fetch`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- When you need to perform MCP Fetch — Web Content Extraction operations or tasks
- When managing MCP Fetch — Web Content Extraction infrastructure or configurations
- When automating or debugging MCP Fetch — Web Content Extraction workflows
- **Triggers**: "mcp fetch — web content extraction" required for a project
