...
Automated reasoning and workflow tool for `docker-management`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
- [ ] "Docker Management" operations completed successfully
...
Set up required environment, dependencies, and configuration for "Docker Management".

### Phase 2: Execution

Run the primary "Docker Management" operations according to the defined requirements.
