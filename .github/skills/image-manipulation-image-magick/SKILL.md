...
Automated reasoning and workflow tool for `image-manipulation-image-magick`. Execute multi-step tasks with deterministic quality controls and structured outputs.
