...
async def main():
    ...
    tpl_django = await loop.run_in_executor(None, _load_json_sync, TEMPLATES / 'settings-django.json') or {}
    tpl_node = await loop.run_in_executor(None, _load_json_sync, TEMPLATES / 'settings-node.json') or {}
