...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--template", choices=list(SAMPLE_TEMPLATES.keys()), default="hello-world", help="Sample template type"
    )
    ...
    parser.add_argument(
        "--language", choices=["python", "js", "ts", "rust"], default="python", help="Programming language"
    )
