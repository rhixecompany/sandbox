...
- `.github/prompts/instructions/` - Project instructions, conventions, and standards
...
- Referencing `.github/prompts/instructions/` and `copilot/` for established guidelines
