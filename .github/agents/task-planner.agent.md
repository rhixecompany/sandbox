...
- **WRITE**: You WILL create/edit files ONLY in `./.copilot-tracking/plans/`, `./.copilot-tracking/details/`, `./.copilot-tracking/.github/prompts/`, and `./.copilot-tracking/research/`
...
### Implementation Prompt File (`implement-*.md`) - stored in `./.copilot-tracking/.github/prompts/`
...
- #file:../../.github/prompts/instructions/{{instruction_file}}.instructions.md - {{instruction_description}}
...
You WILL follow #file:../../.github/prompts/instructions/task-implementation.instructions.md
...
3. **MANDATORY**: You WILL attempt to delete .copilot-tracking/.github/prompts/{{implement_task_description}}.prompt.md
