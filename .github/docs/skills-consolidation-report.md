...
|----------|--------|--------------------|
| development | 164 | Largest — scripts/tools collection, well-organized |
| devops | 66 | Tools + workflows, already linked from root |
| creative | 43 | Design/content skills, cohesive by theme |
| software-development | 41 | Superpowers collection, already well-consolidated |
| mlops | 39 | ML/AI skills, organized by subdomain |
