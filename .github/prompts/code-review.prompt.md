...
- Task 1.1 — Identify review scope and classify high-risk modules.- Task 1.2 — Verify correctness against expected business behavior.- Task 1.3 — Evaluate security controls and input validation boundaries.- Task 1.4 — Assess test coverage and CI readiness for changed behavior.- Task 1.5 — Deliver severity-ranked findings with evidence.
