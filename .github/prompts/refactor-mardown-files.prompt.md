...
description: "Refactor and update Banking documentation files (`AGENTS.md` and `.github/copilot-instructions.md`)\
  ...
  \ conventions and Di\xE1taxis principles."
version: 1.0.0
license: MIT
author: Hermes Agent
toolsets:
