...
## Goal
Break an implementation plan into ordered GitHub issues aligned with milestones and dependencies.
...
- Title: Phase name from implementation plan- Description: Phase details, requirements, and context- Labels: Appropriate for issue type (feature/chore)

## Template References

Templates in `templates/create-github-issues-feature-from-implementation-plan/`:- `phases.md`
