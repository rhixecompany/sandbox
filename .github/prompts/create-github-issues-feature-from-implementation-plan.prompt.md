...
description: Create GitHub Issues from implementation plan phases using feature_request.yml or
  chore_request.yml templates.
version: 1.0.0
license: MIT
author: Hermes Agent
toolsets:
