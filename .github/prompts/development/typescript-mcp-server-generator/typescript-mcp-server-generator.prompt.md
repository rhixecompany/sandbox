...
## Goal
Generate a complete TypeScript MCP server project including tools, resources, configuration, and tests for a specified domain.
...
Templates in `templates/`:- `implementation_details.md`- `phases.md`
