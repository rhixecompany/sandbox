...
Templates in `templates/`:- `configuration.md`- `data_layer_repositories.md`- `dependency_injection__com.md`- `logging.md`- `project_setup__structure.md`- `security.md`- `service_layer.md`- `testing.md`- `web_layer_controllers.md`
