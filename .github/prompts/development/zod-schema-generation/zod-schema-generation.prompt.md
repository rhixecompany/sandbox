...
## Goal
Generate Zod v3+ validation schemas from TypeScript types, database schemas, or JSON samples with proper type inference, custom error messages, and best practices for schema composition.
