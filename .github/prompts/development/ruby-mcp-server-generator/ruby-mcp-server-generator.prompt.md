...
Detailed templates in `templates/`:- `libmy_mcp_serverpromptscode_re.md`- `libmy_mcp_serverresourcesexamp.md`- `libmy_mcp_serverserverrb_templ.md`- `libmy_mcp_servertoolscalculate.md`- `libmy_mcp_servertoolsgreet_too.md`- `testtoolscalculate_tool_testrb.md`- `testtoolsgreet_tool_testrb_tem.md`- `usage.md`
