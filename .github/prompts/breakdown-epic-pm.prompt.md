...
metadata:
  hermes: {}
---
## GoalPrompt for creating an Epic Product Requirements Document (PRD) for a new epic. This PRD will be used as input for generating a technical architecture specification.
...
## Template ReferencesTemplates in `templates/breakdown-epic-pm/`:- `output_format.md`- `phases.md`
