...
## Goal
Generate a concise TLDR summary page that distills a longer document into key takeaways.
...
Detailed templates in `templates/`:- `examples.md`- `output_formatting_rules.md`- `usage.md`
