...
## Goal
Surfaces Entity Framework Core best practices for modeling, querying, migrations, and performance.
...
- [Querying](#querying)
- [Change Tracking & Saving](#change-tracking-&-saving)
- [Security](#security)
- [Test](#test)
