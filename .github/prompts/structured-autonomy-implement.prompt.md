...
metadata:
  ...
  copilot:
    ...
    keybinding: null
  opencode:
    command: opencode /structured-autonomy-implement
    flags: {}
    help: Structured Autonomy Implementation Prompt.
  codex:
    model_override: null
...
Templates in `templates/structured-autonomy-implement/`:- `legacy_prompt_details.md`- `phases.md`
