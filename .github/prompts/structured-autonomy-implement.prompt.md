...
metadata:
  hermes: {}
---
## GoalStructured Autonomy Implementation Prompt.
...
## Template ReferencesTemplates in `templates/structured-autonomy-implement/`:- `legacy_prompt_details.md`- `phases.md`
