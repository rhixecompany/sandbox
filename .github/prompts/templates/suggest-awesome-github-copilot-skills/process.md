...
2. **Scan Local Skills**: Discover existing skill folders in `.github/prompts/skills/` folder
...
12. **Download/Update Assets**: For requested skills, automatically:
    - Download new skills to `.github/prompts/skills/` folder, preserving the folder structure
