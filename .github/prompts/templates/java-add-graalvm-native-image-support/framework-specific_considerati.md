---
# framework-specific considerati

> PLACEHOLDER — referenced by prompt `java-add-graalvm-native-image-support.prompt.md`. Author the real instructional content here.
