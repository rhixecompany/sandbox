# repo-tooling-implementation Template

Prompt: repo-tooling-implementation.prompt.md
Lines: 163
Templates: 1
...
- Shared dependencies: `templates/_shared/deps-core.md`

---

> TODO-to-author: add per-repo tooling config paths once the workspace template set is finalized.
