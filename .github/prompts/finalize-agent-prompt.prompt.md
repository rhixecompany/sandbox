...
description: Finalize prompt file using the role of an AI agent to polish the prompt for the end
  user.
version: 1.0.0
license: MIT
author: Hermes Agent
