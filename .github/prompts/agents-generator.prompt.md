...
- always follow the coding standards and best practices outlined in the project's documentation.Update `AGENTS.md` for the user, then ask for feedback on any unclear or incomplete sections to iterate.
