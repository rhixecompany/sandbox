...
metadata:
  hermes: {}
---
## GoalTransform this Python script into a polished, beginner-friendly project by refactoring the code, adding clear instructional comments, and generating a complete markdown tutorial.
...
## Template ReferencesTemplates in `templates/comment-code-generate-a-tutorial/`:- `legacy_prompt_details.md`- `phases.md`
