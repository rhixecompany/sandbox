...
description: Refactor given method `${input:methodName}` to reduce its cognitive complexity to
  `${input:complexityThreshold}` or below, by extracting helper methods.
version: 1.0.0
license: MIT
author: Hermes Agent
toolsets:
