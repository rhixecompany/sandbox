...
## Goal
Generate a pull request body, checklist, and review guidance directly from a feature specification.
...
Templates in `templates/create-github-pull-request-from-specification/`:- `phases.md`
