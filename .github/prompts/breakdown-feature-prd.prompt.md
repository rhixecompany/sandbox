...
description: Prompt for creating Product Requirements Documents (PRDs) for new features, based
  on an Epic.
version: 1.0.0
license: MIT
author: Hermes Agent
