...
metadata:
  hermes: {}
---
## GoalPrompt and workflow for generating conventional commit messages using a structured XML format. Guides users to create standardized, descriptive commit messages in line with the Conventional Commits specification, including instructions, examples, and validation.

## ContextUse when you need to conventional commit for the current workspace or task.
...
## Template ReferencesTemplates in `templates/conventional-commit/`:- `legacy_prompt_details.md`- `phases.md`
