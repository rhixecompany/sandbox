...
## Goal
Generate a Conventional Commits message from a staged diff or summary of changes, following the standard types and scopes.
...
Templates in `templates/conventional-commit/`:- `legacy_prompt_details.md`- `phases.md`
