...
- Prompt templates: store templates under `.github/prompts/` and load via a safe helper. Keep templates small and testable.
...
- Store canonical prompts under `.github/prompts/` and reference them by filename from code.
