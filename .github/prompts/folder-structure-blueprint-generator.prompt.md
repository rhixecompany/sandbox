...
## Goal
Analyzes and documents project folder structures across diverse technology stacks (.NET, Java, React, Angular, Python, Node.js, Flutter) and produces consistent blueprints with naming and placement conventions.
...
- [Generated Prompt](#generated-prompt)
  - [Initial Auto-detection Phase](#initial-auto-detection-phase)
...
Detailed templates in `templates/folder-structure-blueprint-generator/`:- `configuration_variables.md`- `generated_prompt.md`
