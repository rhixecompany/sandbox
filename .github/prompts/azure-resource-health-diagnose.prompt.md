...
description: Analyze Azure resource health, diagnose issues from logs and telemetry, and create
  a remediation plan for identified problems.
version: 1.0.0
license: MIT
author: Hermes Agent
toolsets:
