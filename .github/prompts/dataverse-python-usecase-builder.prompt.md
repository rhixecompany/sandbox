...
description: Generate complete solutions for specific Dataverse SDK use cases with architecture
  recommendations
version: 1.0.0
license: MIT
author: Hermes Agent
