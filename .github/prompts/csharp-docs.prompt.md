...
description: Ensure that C# types are documented with XML comments and follow best practices for
  documentation.
version: 1.0.0
license: MIT
author: Hermes Agent
