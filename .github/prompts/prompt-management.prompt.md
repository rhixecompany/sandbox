...
...
plan: ''
dependencies: - skill:brainstorming
...
- If both are valid, keep the one closer to `.github/prompts/*.prompt.md`
...
- `docs/prompt-inventory.md`
- `docs/prompt-validation-report.md`
- updated `.github/prompts/*.prompt.md` files using templates
