...
## Goal
Produces a complete Epic PRD ready for downstream feature planning, written from a product manager perspective.
...
- [Rules](#rules)
- [Phases](#phases)
  - [Phase 1: Understand the epic](#phase-1:-understand-the-epic)
...
Templates in `templates/hermes-breakdown-epic-pm/`:- `phases.md`
