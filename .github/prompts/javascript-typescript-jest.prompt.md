...
description: Best practices for writing JavaScript/TypeScript tests using Jest, including mocking
  strategies, test structure, and common patterns.
version: 1.0.0
license: MIT
author: Hermes Agent
toolsets:
