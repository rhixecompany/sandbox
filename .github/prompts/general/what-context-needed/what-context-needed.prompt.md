...
## Goal
Ask Copilot which files it needs to see before answering a question, helping the user identify required context for accurate AI responses.
...
- [Files I Need>](#files-i-need>)
  - [Must See (required for accurate answer)](#must-see-required-for-accurate-answer)
...
Templates in `templates/`:- `files_i_need.md`- `phases.md`
