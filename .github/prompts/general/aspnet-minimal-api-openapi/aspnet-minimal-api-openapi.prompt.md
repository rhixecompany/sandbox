...
> ` to represent multiple response types- Return `TypedResults` instead of `Results` for strongly-typed responses- use C# 10+ features like nullable annotations and init-only properties
...
Templates in `templates/`:- `api_organization.md`- `openapi_documentation.md`- `request_and_response_type.md`- `type_handling.md`
