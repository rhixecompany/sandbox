...
- [Step 1: Research and Gather Context](#step-1:-research-and-gather-context)
- [Step 2: Determine Commits](#step-2:-determine-commits)
- [Step 3: Plan Generation1. Generate draft plan using <output_template](#step-3:-plan-generation1-generate-draft-plan-using-<output_template)
...
Templates in `templates/`:- `implementation_steps.md`- `phases.md`- `step_3_plan_generation.md`
