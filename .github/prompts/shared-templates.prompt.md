...
description: Index of all prompt templates under prompts/templates/. Shared templates under _shared/ are the canonical source for frontmatter schema, skill references, and verification gates.
version: 1.1.0
author: Hermes Agent
license: MIT
...
This directory contains the canonical shared templates and extracted per-prompt templates. Every `.prompt.md` should reference these for cross-cutting concerns (frontmatter, skills, verification) instead of duplicating the same content.
...
## Goal
Index of all prompt templates under prompts/templates/. Shared templates under _shared/ are the canonical source for frontmatter schema, skill references, and verification gates.
