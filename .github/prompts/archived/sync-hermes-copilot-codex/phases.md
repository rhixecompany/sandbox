...
**Inputs:** `.github/prompts/agents/` and `.github/prompts/instructions/` directories
...
| Step | Action                                                   | Output                |
| ---- | -------------------------------------------------------- | --------------------- |
| 1.1  | List all files in `.github/prompts/instructions/`                | Instruction inventory |
| 1.2  | For each instruction, create a corresponding personality | Personalities created |
| 1.3  | List all files in `.github/prompts/agents/`                      | Agent inventory       |
