...
2. **Scan Local Instructions**: Discover existing instruction files in `.github/prompts/instructions/` folder
...
12. **Download/Update Assets**: For requested instructions, automatically:
    - Download new instructions to `.github/prompts/instructions/` folder
