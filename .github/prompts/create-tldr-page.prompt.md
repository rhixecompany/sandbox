...
description: Create a tldr page from documentation URLs and command examples, requiring both URL
  and command name.
version: 1.0.0
license: MIT
author: Hermes Agent
