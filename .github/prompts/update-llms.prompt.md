...
description: Update the llms.txt file in the root folder to reflect changes in documentation or
  specifications following the llms.txt specification at https://llmstxt.org/
version: 1.0.0
license: MIT
author: Hermes Agent
toolsets:
