...
Define how `.github/prompts/*.txt` should convert to `.github/prompts/*.md` and what must be
preserved.
...
- [ ] Map `.github/prompts/*.txt` to their `.md` counterparts
...
2. Map all `.github/prompts/*.txt` → `.github/prompts/*.md` pairs
...
4. Write to `.github/prompts/<same-stem>.md` (overwrite if exists)
...
- [ ] Convert all `.github/prompts/*.txt` → `.github/prompts/*.md` (Step 5.3)
- [ ] Boost all `.github/prompts/*.md` files (Step 5.4)
...
- [ ] Structural audit all `.github/prompts/*.md` files
