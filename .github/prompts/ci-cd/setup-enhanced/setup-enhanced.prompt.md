...
Detailed section templates in `templates/`:- `10__anti-rate-limiting_strateg.md`- `11__phase_execution_checklists.md`- `3__reference_resolution_hierar.md`- `4__dry_implementation_practice.md`- `5__implementation_workflow_10_.md`- `6__feature_implementation_phas.md`- `7__content_integration_rules_d.md`- `9__ai_personas_for_copilot_cli.md`
