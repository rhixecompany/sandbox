...
1. All operational scripts should end up under `projects/Bash/**` unless a framework seed
   script is exempt.
...
**Core script baselines**: `projects/projects/Bash/upgrade.sh`, `projects/projects/Bash/Banking/scripts/orchestrator.sh/.bat/.ps1`, `projects/projects/Bash/comicwise/dev.sh/.ps1`
