...
## Goal
Run pytest with coverage, discover lines missing coverage, and increase coverage to 100% on the current workspace.
...
Templates in `templates/pytest-coverage/`:- `legacy_prompt_details.md`- `phases.md`
