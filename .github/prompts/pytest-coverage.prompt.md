...
description: Run pytest tests with coverage, discover lines missing coverage, and increase coverage
  to 100%.
version: 1.0.0
license: MIT
author: Hermes Agent
