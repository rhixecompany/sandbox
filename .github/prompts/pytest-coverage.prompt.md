...
metadata:
  hermes: {}
---
## GoalRun pytest tests with coverage, discover lines missing coverage, and increase coverage to 100%.
...
## Template ReferencesTemplates in `templates/pytest-coverage/`:- `legacy_prompt_details.md`- `phases.md`
