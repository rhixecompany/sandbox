...
## Goal
Free disk space by cleaning caches, temporary files, unused dependencies, and old logs — with safe execution and clear verification steps.
...
See `templates/disk-space-cleanup/README.md` for phases/steps/workflow.

## Steps

1. Read `templates/disk-space-cleanup/README.md`.
