...
Execute the `all-repo-docker-setup` workflow. Full details: `templates/all-repo-docker-setup/README.md`.

## Template Reference

Detailed template in `templates/all-repo-docker-setup/`:
- `README.md`

## Execution

See `templates/all-repo-docker-setup/README.md` for phases/steps/workflow.

## Steps

1. Read `templates/all-repo-docker-setup/README.md`.
