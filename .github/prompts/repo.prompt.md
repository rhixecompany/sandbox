...
...
description: "Research all 16 projects via delegated sub-prompts: web search for similar projects,\
  \ guides, cheatsheets; create or update RESEARCH_REPORT.md per project in crisp\
  \ markdown. Delegates web research to web-research-pipeline.prompt.md and post-research\
  \ ops to repo-management.prompt.md.\nAlso includes Quick Repo Onboarding (Q1\u2013\
  Q4): summarize repo in 5 bullets, find main entrypoint, check current directory,\
...
...
plan: ''
dependencies: - prompt:context-map
