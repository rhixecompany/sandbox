...
2. **Enhance** — Add missing sections using shared templates from `templates/` without inlining duplicate content.
...
Shared templates live in `templates/` (frontmatter.md, rules-core.md, skills-table-core.md, goals.md, phases.md, best-practices.md, verification-checklist.md, personality.md, personas.md, deps-core.md, section-skeleton.md, skill-refs.md).
...
1. **DRY first** — Reference shared templates in `templates/` instead of inlining content. Each section heading should link to the corresponding shared template.
...
4. Review shared templates in `templates/` for section structure and DRY references.
...
- Skills table uses `templates/skills-table-core.md` reference
...
1. **DRY** — Reference shared templates in `templates/` instead of duplicating content. Every standardized section (Personas, Personality, Rules, Best Practices, Verification Checklist, Dependencies) links to its template.
...
- **Shared templates** — `templates/` must exist with all 12 reference files
