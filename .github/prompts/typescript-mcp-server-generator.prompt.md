...
description: Generate a complete MCP server project in TypeScript with tools, resources, and proper
  configuration
version: 1.0.0
license: MIT
author: Hermes Agent
