...
## Goal
Author an MADR-formatted Architectural Decision Record capturing context, decision, and consequences.
...
Templates in `templates/`:- `phases.md`- `required_documentation_st.md`
