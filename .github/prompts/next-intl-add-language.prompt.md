...
metadata:
  hermes: {}
---
## GoalAdd new language to a Next.js + next-intl application.
...
## Template ReferencesTemplates in `templates/next-intl-add-language/`:- `legacy_prompt_details.md`- `phases.md`
