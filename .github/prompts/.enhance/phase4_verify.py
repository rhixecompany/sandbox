...
def main() -> int:
    ...
    KNOWN_FENCE_CONVENTIONS = {
        ...
        str(Path("templates") / "create-architectural-decision-record" / "required_documentation_st.md"),
        str(Path("templates") / "create-github-action-workflow-specification" / "token_optimization_strate.md"),
        str(Path("templates") / "memory-merger" / "process.md"),
        str(Path("templates") / "structured-autonomy-plan" / "step_3_plan_generation.md"),
        str(Path("templates") / "update-markdown-file-index" / "files_in_folder.md"),
