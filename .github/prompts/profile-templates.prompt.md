...
> Location: `templates/profile-templates/`
...
1. Copy templates from `templates/profile-templates/` to `~/AppData/Local/hermes/profiles/<name>/`
...
1. Compare existing profile files against templates in `templates/profile-templates/`
