...
## Goal
Plan a multi-file refactor with proper sequencing, dependency analysis, and rollback steps before any code changes are made.
...
- [Refactor Plan: [title]](#refactor-plan:-[title])
...
> [Brief description of how items work now]
> [Brief description of how items will work after]
> **Full content:**
...
Templates in `templates/`:- `phases.md`- `refactor_plan_title.md`
