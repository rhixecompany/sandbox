...
Shared baseline variant with no executor bias. Run command-first audit and
reconciliation for Hermes, Copilot CLI and ACPX.

## Context

> - Primary executor: none (neutral).
> - Shell: PowerShell-first commands, runnable from bash.

> **Full content:** `templates/plan-acpx-agent-stack-audit-shared/context.md`
...
> **Full content:** `templates/plan-acpx-agent-stack-audit-shared/phases.md`
...
Templates in `templates/plan-acpx-agent-stack-audit-shared/`:
- `context.md`
- `phases.md`
