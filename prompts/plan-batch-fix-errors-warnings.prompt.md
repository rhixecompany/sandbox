...
> Batch fix all errors, warnings, and deprecations surfaced by `pnpm install`, `pn
> #### Phase 1: Error & Warning Collection

> **Full content:** `templates/plan-batchFixAllErrorsWarningsDeprecations/plan_batch_fix_all_errors_warn.md`

## Template References

Detailed templates in `templates/plan-batchFixAllErrorsWarningsDeprecations/`:
- `plan_batch_fix_all_errors_warn.md`
