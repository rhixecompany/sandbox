---
name: "kanban-prompt"
title: "Prompt — Implement Kanban (Multi-Agent Board) Feature"
---

# Implementation Prompt: kanban

You are implementing the Hermes feature described in docs/features/kanban.md (1276 lines).
Steps:
