---
name: "tool-gateway-prompt"
title: "Prompt — Implement Nous Tool Gateway Feature"
---

# Implementation Prompt: tool-gateway

You are implementing the Hermes feature described in docs/features/tool-gateway.md (223 lines).
Steps:
