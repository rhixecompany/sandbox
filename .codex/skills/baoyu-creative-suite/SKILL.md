---
author: 宝玉 (JimLiu)
description: 'Unified Baoyu creative suite: Infographics (21 layouts × 21 styles), Knowledge Comics (知识漫画), and Article Illustrations (article-illustrator). Three tools in one skill with shared workflow engine.'
license: MIT
metadata:
  hermes:
...
- macos
- windows
title: "Baoyu Creative Suite (Infographics + Comics + Article Illustrations)"
version: 2.0.0
---
---
...
- `references/structured-content-template.md` — Infographic content format
- `references/base-prompt.md` — Infographic prompt template
- `references/layouts/<layout>.md` — 21 infographic layout definitions
- `references/styles/<style>.md` — 21 infographic style definitions
- `references/comic-workflow.md` — Comic detailed workflow
- `references/auto-selection.md` — Comic content signal analysis
- `references/art-styles/<style>.md` — Comic art style definitions
- `references/tones/<tone>.md` — Comic tone definitions
- `references/presets/<preset>.md` — Comic preset rules
- `references/layouts/<layout>.md` — Comic layout definitions
- `references/character-template.md` — Comic character definition format
- `references/ohmsha-guide.md` — Ohmsha manga specifics
- `references/partial-workflows.md` — Comic partial workflow options
- `references/storyboard-template.md` — Comic storyboard structure
- `references/prompt-construction.md` — Article illustrator prompt templates
- `references/style-presets.md` — Article illustrator presets
- `references/article-illustrator-styles.md` — Article illustrator style gallery
- `references/palettes/<palette>.md` — Article illustrator palettes
- `references/article-illustrator-workflow.md` — Article illustrator workflow
- `references/usage.md` — Article illustrator invocation examples
