...
Automated reasoning and workflow tool for `codebase-inspection`. Execute multi-step tasks with deterministic quality controls and structured outputs.
...
Perform the codebase inspection operations following the skill instructions.
