...
```json
{
	"status": "success",
	"prompt_id": "abc-123",
	"outputs": [{ "file": "./outputs/sdxl_00001_.png", "node_id": "9", "type": "image", "filename": "sdxl_00001_.png" }]
}
```
...
Set parameters, styles, and options for the desired comfyui output.

### Phase 3: Generate

Execute the comfyui process to produce the final result.
...
The Skills\creative\comfyui\skill.md skill provides tools and workflows for managing skills\creative\comfyui\skill.md operations efficiently.
