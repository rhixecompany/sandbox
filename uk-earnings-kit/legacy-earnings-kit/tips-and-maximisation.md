# UK Money Earning Sites — Tips & Maximisation Guide
...
## Prolific-Specific Tips

1. **Install the Prolific Assistant** browser extension — it alerts you when new studies drop
2. **Keep the "About You" section** fully completed — every single question
3. **Be fast**: studies with 100 places fill in under 30 seconds
4. **Don't refresh constantly** — you'll get rate-limited. Every 30 sec is fine
5. **Use a wired internet connection** if possible — every ms counts
6. **Return studies you don't qualify for** — don't just close the tab
7. **Join the r/ProlificAc subreddit** — users post when batches drop
8. **Rejections are serious** — keep your approval rate above 95%

## UserTesting Tips

1. **Speak constantly** — silence = bad rating
2. **Think out loud**: "I'm looking for the search bar... I expected it to be at the top right..."
3. **Be honest**: if something is confusing, say so. That's what they're paying for
4. **Rate 5 stars** at the end — ask for it politely
5. **Use the mobile app** — more tests appear there than on desktop
6. **Keep the dashboard open** while working
7. **Update demographics monthly** — new filters change what you qualify for

## Freecash Tips

1. **Game offers pay more than surveys** — focus on these
2. **Track offer progress carefully** — screenshot the requirements
3. **Compare offerwalls**: the same game can pay different amounts on different walls (e.g., OfferToro vs AdGate vs Ayet)
4. **Check daily bonuses** — free coins each day
5. **Set a timer** — some game offers expire after 30 days
6. **Don't use ad-blockers** — they can break tracking

## DataAnnotation Tips

1. **The qualification test matters** — take it seriously, spend time on it
2. **Quality over speed** — poor quality = no more projects
3. **Read guidelines thoroughly** — each project has specific rules
4. **Start with writing projects** — they're easier to get than coding ones
5. **Be consistent** — regular workers get more project invites
6. **Don't rush** — you're paid hourly, accuracy matters more than volume
...
- [ ] Verify minimum payout is reasonable (under £25)
- [ ] Verify PayPal as a withdrawal option
- [ ] Read the privacy policy — do they sell your data?
...
- You'll pay:
  - **Class 2 NIC**: £3.45/week if profits over £6,725/year
  - **Class 4 NIC**: 9% on profits between £12,570–£50,270
