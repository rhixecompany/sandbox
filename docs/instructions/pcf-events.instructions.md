...
Model Driven Apps use the [addEventHandler method](https://learn.microsoft.com/en-us/power-apps/developer/model-driven-<REDACTED_BLOB>) to associate event handlers to custom events for a component.
