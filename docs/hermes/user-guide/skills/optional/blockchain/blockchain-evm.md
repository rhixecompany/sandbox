...
Helper script path: `~/./skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/./skills/blockchain/evm/scripts/evm_client.py
...
python ~/./skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/./skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
