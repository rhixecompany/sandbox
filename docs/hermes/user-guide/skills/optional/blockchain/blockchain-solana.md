...
Helper script path: ~/./skills/blockchain/solana/scripts/solana_client.py
...
python ~/./skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/./skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/./skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/./skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/./skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/./skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
