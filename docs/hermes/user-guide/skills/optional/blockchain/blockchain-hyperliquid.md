...
The script reads `${HERMES_HOME:-~/$HERMES_HOME}/.env` for two optional defaults:
...
Helper script: `~/./skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/./skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${HERMES_HOME:-~/$HERMES_HOME}/.env`.
...
```bash
python ~/./skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/./skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
