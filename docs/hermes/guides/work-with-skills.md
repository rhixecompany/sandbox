...
What happens:
1. The skill directory is copied to `~/./skills/`
...
```markdown title="~/./skills/my-category/my-skill/SKILL.md"
---
name: my-skill
...
The skill appears automatically — no registration needed. Drop it in `~/./skills/` and it's live.
...
**Use categories.** Organize skills into subdirectories (`~/./skills/devops/`, `~/./skills/research/`, etc.). This keeps the list manageable and helps the agent find relevant skills faster.
