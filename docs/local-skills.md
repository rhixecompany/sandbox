...
│ distributed-llm-pretraining-torchtitan      │                      │ local  │ local │ enabled │
│ here.now                                    │                      │ local  │ local │ enabled │
│ hermes-breakdown                            │                      │ local  │ local │ enabled │
│ hermes-hooks                                │                      │ local  │ local │ enabled │
│ hermes-mcp                                  │                      │ local  │ local │ enabled │
│ hermes-skills                               │                      │ local  │ local │ enabled │
│ hermes-system-maintenance                   │                      │ local  │ local │ enabled │
│ huggingface-accelerate                      │                      │ local  │ local │ enabled │
│ ideation                                    │                      │ local  │ local │ enabled │
│ inference-sh-cli                            │                      │ local  │ local │ enabled │
│ lambda-labs-gpu-cloud                       │                      │ local  │ local │ enabled │
│ modal-serverless-gpu                        │                      │ local  │ local │ enabled │
│ optimizing-attention-flash                  │                      │ local  │ local │ enabled │
│ peft-fine-tuning                            │                      │ local  │ local │ enabled │
│ profile-maintenance                         │                      │ local  │ local │ enabled │
│ qdrant-vector-search                        │                      │ local  │ local │ enabled │
│ qwen-code                                   │                      │ local  │ local │ enabled │
│ simpo-training                              │                      │ local  │ local │ enabled │
│ skill-creator                               │                      │ local  │ local │ enabled │
│ skill-judge                                 │                      │ local  │ local │ enabled │
│ stable-diffusion-image-generation           │                      │ local  │ local │ enabled │
│ template                                    │                      │ local  │ local │ enabled │
│ using-git-worktrees                         │                      │ local  │ local │ enabled │
│ validate-memories                           │                      │ local  │ local │ enabled │
│ writing-skills                              │                      │ local  │ local │ enabled │
│ architecture-blueprint-generator            │ architecture         │ local  │ local │ enabled │
│ folder-structure-blueprint-generator        │ architecture         │ local  │ local │ enabled │
│ technology-stack-blueprint-generator        │ architecture         │ local  │ local │ enabled │
...
│ coding-agents                               │ autonomous-ai-agents │ local  │ local │ enabled │
│ customize-opencode                          │ autonomous-ai-agents │ local  │ local │ enabled │
│ enhance-markdown                            │ autonomous-ai-agents │ local  │ local │ enabled │
│ hermes-skill-library-maintenance            │ autonomous-ai-agents │ local  │ local │ enabled │
│ template-skill                              │ autonomous-ai-agents │ local  │ local │ enabled │
...
│ excalidraw-diagram-generator                │ creative             │ local  │ local │ enabled │
│ frontend-design                             │ creative             │ local  │ local │ enabled │
│ image-manipulation-image-magick             │ creative             │ local  │ local │ enabled │
...
│ nano-banana-pro-openrouter                  │ creative             │ local  │ local │ enabled │
...
│ writing-clearly-and-concisely               │ creative             │ local  │ local │ enabled │
│ ai-prompt-engineering-safety-review         │ development          │ local  │ local │ enabled │
...
│ copilot-usage-metrics                       │ development          │ local  │ local │ enabled │
│ create-agentsmd                             │ development          │ local  │ local │ enabled │
│ create-implementation-plan                  │ development          │ local  │ local │ enabled │
│ create-readme                               │ development          │ local  │ local │ enabled │
│ create-web-form                             │ development          │ local  │ local │ enabled │
│ generate-custom-instructions-from-codebase  │ development          │ local  │ local │ enabled │
│ lsp-setup                                   │ development          │ local  │ local │ enabled │
...
│ suggest-awesome-github-copilot-agents       │ development          │ local  │ local │ enabled │
│ suggest-awesome-github-copilot-instructions │ development          │ local  │ local │ enabled │
│ update-implementation-plan                  │ development          │ local  │ local │ enabled │
...
│ vscode-workspace-configurator               │ development          │ local  │ local │ enabled │
│ workiq-copilot                              │ development          │ local  │ local │ enabled │
│ appinsights-instrumentation                 │ devops               │ local  │ local │ enabled │
│ asdf                                        │ devops               │ local  │ local │ enabled │
│ aspire                                      │ devops               │ local  │ local │ enabled │
│ azure-deployment-preflight                  │ devops               │ local  │ local │ enabled │
...
│ git-history-preserving-migration            │ devops               │ local  │ local │ enabled │
│ github-actions-efficiency                   │ devops               │ local  │ local │ enabled │
│ glab                                        │ devops               │ local  │ local │ enabled │
│ hermes-config-troubleshooting               │ devops               │ local  │ local │ enabled │
...
│ projects-multi-repo-init-normalize          │ devops               │ local  │ local │ enabled │
│ provider-reliability-diagnostics            │ devops               │ local  │ local │ enabled │
...
│ terraform-azurerm-set-diff-analyzer         │ devops               │ local  │ local │ enabled │
│ webhook-subscriptions                       │ devops               │ local  │ local │ enabled │
│ windows-maintenance-operations              │ devops               │ local  │ local │ enabled │
│ work-on-ticket                              │ devops               │ local  │ local │ enabled │
│ workspace-audit                             │ devops               │ local  │ local │ enabled │
│ finishing-a-development-branch              │ github               │ local  │ local │ enabled │
...
│ transloadit-media-processing                │ media                │ local  │ local │ enabled │
...
│ prompt-planning-orchestration               │ planning             │ local  │ local │ enabled │
│ prd                                         │ product              │ local  │ local │ enabled │
│ doc-coauthoring                             │ productivity         │ local  │ local │ enabled │
│ documentation-extraction-and-indexing       │ productivity         │ local  │ local │ enabled │
...
│ user-communication-preferences              │ productivity         │ local  │ local │ enabled │
│ xlsx                                        │ productivity         │ local  │ local │ enabled │
│ boilerplate-stripper                        │ qa                   │ local  │ local │ enabled │
│ playwright-automation-fill-in-form          │ qa                   │ local  │ local │ enabled │
│ playwright-generate-e2e-test                │ qa                   │ local  │ local │ enabled │
...
│ verification-before-completion              │ qa                   │ local  │ local │ enabled │
...
│ bash-scripts-audit-remediation              │ software-development │ local  │ local │ enabled │
