...
- SKILL.md line count: 30 (threshold >=10: True)
  - plan (tools-plan.md): present=True, size=399 bytes
  - spec (tools-spec.md): present=True, size=964 bytes
  - prompt (tools-prompt.md): present=True, size=678 bytes
  - skill (SKILL.md): present=True, size=1167 bytes
  - script (tools-execute.py): present=True, size=1259 bytes
