...
> Generated: 2026-07-09 18:56  |  Source prompt: `prompts/agents-fix.prompt.md`  |  Mode: **live file-backed**
...
| Hermes agent-style prompts (`prompts/*.prompt.md`) | 215 |
| Codex twin agents | 1 |
| Cross-reference rows generated | 387 |
...
| Agents present only in Copilot (not Hermes) | 171 |
| Agents present only in Hermes (not Copilot) | 213 |
...
Built a 387-row mapping table linking equivalent agents across Copilot, Codex,
